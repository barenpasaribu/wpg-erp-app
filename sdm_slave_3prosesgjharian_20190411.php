...
if (mysql_num_rows($qcekuser) > 0) {
    ...
    mysql_query($str);
    $query1 = selectQuery($dbname, 'datakaryawan', 'karyawanid, nik, namakaryawan, jms, statuspajak, npwp, kodejabatan, tipekaryawan, kodegolongan, idmedical', "tipekaryawan in(1,2,3,4,6) and lokasitugas='".$_SESSION['empl']['lokasitugas']."' and (tanggalkeluar>='".$tanggal1."' or tanggalkeluar is NULL) and alokasi=0 and sistemgaji='Harian' and ( tanggalmasuk<='".$tanggal2."' or tanggalmasuk='0000-00-00' or tanggalmasuk is null) and karyawanid not in (0999999999,0888888888) order by karyawanid");

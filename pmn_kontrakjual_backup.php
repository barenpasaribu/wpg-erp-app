...
<input type=hidden id=method name=method value='insert' />     <fieldset>
          ...
          <fieldset>
			...
			<tr>
			<td>".$_SESSION['lang']['NoKontrak']."</td><td><input type=text class=myinputtext id=noKtrk name=noKtrk maxlength=100 onkeypress=\"return tanpa_kutip(event)\" style=\"width:150px;\" /></td>
          ...
          <fieldset>
                        ...
                        <tr><td>Kwalitet</td><td>:</td><td><textarea  style=\"height: 50px; width: 170px;\" id=kualitas cols=80 rows=3>FFA : 5,00% MAX, M & I : 0,50% MAX</textarea></td></tr>                                                 
                        </tbody>
                        </table>
						<br/>
						<table cellspacing=1 border=0>
                        ...
                        <tr>
                        <td>".$_SESSION['lang']['payment']." 2</td><td>:</td><td><textarea style=\"height: 50px; width: 170px;\" name=syrtByr2 id=syrtByr2 ></textarea></td></tr>
                        <tr>						
                        <tr>
                        <td>".$_SESSION['lang']['tndaTangan']."</td><td>:</td><td><input type=text name=tndtng id=tndtng class=myinputtext style=\"width: 170px;\" value='Jhon Sudiarman Saragih'/></td></tr>
                        </tbody>
                        </table>						
          </fieldset>
          <br />
...
<table>
            <tr>
                 <td style='valign:top'>Lama Muat (Hari)</td><td><input type=text id=lamamuat name=lamamuat class=myinputtext onkeypress=\"return tanpa_kutip(event);\" style=\"width:300px;\" /></td>
          </tr>
            <tr>
                 <td style='valign:top'>Tipe Muat</td><td><select id=tipemuat name=tipemuat style=\"width:100px;\">".$tipeMuat."</select></td>
          </tr>
          <tr>
     ...
     <table>
            <tr>
                 <td style='valign:top'>".$_SESSION['lang']['catatan']." 1</td><td><input type=text id=cttn1 name=cttn1 class=myinputtext  style=\"width:300px;\" /></td>
          </tr>
          <tr>
                 <td style='valign:top'>".$_SESSION['lang']['catatan']." 2</td><td><input type=text id=cttn2 name=cttn2 class=myinputtext   style=\"width:300px;\" /></td>
          </tr>
           <tr>
                 <td style='valign:top'>".$_SESSION['lang']['catatan']." 3</td><td><input type=text id=cttn3 name=cttn3 class=myinputtext   style=\"width:300px;\" /></td>
          </tr>
           <tr>
                 <td style='valign:top'>".$_SESSION['lang']['catatan']." 4</td><td><input type=text id=cttn4 name=cttn4 class=myinputtext   style=\"width:300px;\" /></td>
          </tr>
           <tr>
                 <td style='valign:top'>".$_SESSION['lang']['catatan']." 5</td><td><input type=text id=cttn5 name=cttn5 class=myinputtext   style=\"width:300px;\" /></td>
          </tr>
            <tr>
                 <td style='valign:top'>".$_SESSION['lang']['catatan']." 6</td><td><input type=text id=cttn6 name=cttn6 class=myinputtext   style=\"width:300px;\" /></td>
          </tr>
          <tr>
                 <td style='valign:top'>".$_SESSION['lang']['catatan']." 7</td><td><input type=text id=cttn7 name=cttn7 class=myinputtext   style=\"width:300px;\" /></td>
          </tr>
           <tr>
                 <td style='valign:top'>".$_SESSION['lang']['catatan']." 8</td><td><input type=text id=cttn8 name=cttn8 class=myinputtext   style=\"width:300px;\" /></td>
          </tr>
           <tr>
                 <td style='valign:top'>".$_SESSION['lang']['catatan']." 9</td><td><input type=text id=cttn9 name=cttn9 class=myinputtext   style=\"width:300px;\" /></td>
          </tr>
           <tr>
                 <td style='valign:top'>".$_SESSION['lang']['catatan']." 10</td><td><input type=text id=cttn10 name=cttn10 class=myinputtext   style=\"width:300px;\" /></td>
          </tr>
            <tr>
                 <td style='valign:top'>".$_SESSION['lang']['catatan']." 11</td><td><input type=text id=cttn11 name=cttn11 class=myinputtext   style=\"width:300px;\" /></td>
          </tr>
          <tr>
                 <td style='valign:top'>".$_SESSION['lang']['catatan']." 12</td><td><input type=text id=cttn12 name=cttn12 class=myinputtext   style=\"width:300px;\" /></td>
          </tr>
           <tr>
                 <td style='valign:top'>".$_SESSION['lang']['catatan']." 13</td><td><input type=text id=cttn13 name=cttn13 class=myinputtext   style=\"width:300px;\" /></td>
          </tr>
           <tr>
                 <td style='valign:top'>".$_SESSION['lang']['catatan']." 14</td><td><input type=text id=cttn14 name=cttn14 class=myinputtext   style=\"width:300px;\" /></td>
          </tr>
           <tr>
                 <td style='valign:top'>".$_SESSION['lang']['catatan']." 15</td><td><input type=text id=cttn15 name=cttn15 class=myinputtext   style=\"width:300px;\" /></td>
          </tr>
		  
           <tr style='display:none'>
                 <td style='valign:top'>".$_SESSION['lang']['catatanlain']." </td><td><input type=text id=othCttn name=othCttn class=myinputtext value=''  style=\"width:300px;\" /></td>
          </tr>
     </table>
        </fieldset>
         <center>

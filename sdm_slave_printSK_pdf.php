...
//  
$paragraf1="Dalam rangka memperoleh hasil guna yang optimum dan sesuai dengan perkembangan perusahaan dewasa ini, dipandang perlu melaksanakan ".$tipesk."  terhadap karyawan lingkungan ".$namaptx.".";
 if($pg1!=='')
     $paragraf1=$pg1;
    ...
    $paragraffadd2='';
        ...
        $pdf->SetFont('Arial','',10); 
         ...
         if($tjsdaerah>0 or $ketjsdaerah>0){   
             $no+=1;
             $pdf->Cell(20,5,$no,1,0,'L');
             $pdf->Cell(50,5,"Tunjangan Prestasi",1,0,'L');
         ...
         if($tjmahal>0 or $ketjmahal>0){   
             $no+=1;
             $pdf->Cell(20,5,$no,1,0,'L');
             $pdf->Cell(50,5,"Tunjangan Kehadiran",1,0,'L');
         ...
         if($tjpembantu>0 or $ketjpembantu>0){   
             $no+=1;
             $pdf->Cell(20,5,$no,1,0,'L');
             $pdf->Cell(50,5,"Tunjangan Lainnya",1,0,'L');
...
//=========penandatangan
        ...
        $pdf->Ln();
        $pdf->Ln();
        $pdf->Cell(40,5,"Pekanbaru, ".$tanggal,'0',1,'L');	
        $pdf->Ln();
        $pdf->Ln();			
        $pdf->Ln();

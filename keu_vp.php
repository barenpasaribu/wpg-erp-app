...

{
    ...
    //$arrayFilters[] = " keu_vpht.updateby = '" . $_SESSION['standard']['userid']."'";
    ...
    $sql = "SELECT * 
			FROM keu_vpht $filter 
			ORDER BY posting,tanggal DESC";
...
//            echoMessage('param ',$parameter);
    ...
    case "getinvoiceform":
        ...
        $optTipe = array('p' => $_SESSION['lang']['po'],

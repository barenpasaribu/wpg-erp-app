...
while ($rRealisasi = mysql_fetch_assoc($qRealisasi)) {
	@$biRealisasi += $rRealisasi['tahuntanam'];
}
...
while ($rRealisasi = mysql_fetch_assoc($qRealisasi)) {
	@$sbiRealisasi += $rRealisasi['tahuntanam'];
}
...
while ($rRealisasi = mysql_fetch_assoc($qRealisasi)) {
	@$prodThnLalusbi += $rRealisasi['tahuntanam'];
}
...
while ($rRealisasi = mysql_fetch_assoc($qRealisasi)) {
	@$prodThnLalu += $rRealisasi['tahuntanam'];
}

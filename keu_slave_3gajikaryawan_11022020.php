...
$str = 'select subbagian,karyawanid,namakaryawan from ' . $dbname . ".datakaryawan where lokasitugas='" . $_SESSION['empl']['lokasitugas'] . "' or kodeorganisasi='" . $_SESSION['empl']['induklokasitugas'] . "'";
$res = mysql_query($str);
$subunit = [];
while ($bar = mysql_fetch_object($res)) {
...
$penalty = 0 ;
$penaltykehadiran = 0;
$query5 = 'select a.karyawanid,sum(a.insentif) as premi from '.$dbname.".kebun_kehadiran_vw a left join ".$dbname.".datakaryawan b on a.karyawanid=b.karyawanid where b.lokasitugas='".$_SESSION['empl']['lokasitugas']."' and  (b.tanggalkeluar>='".$tgmulai."' or b.tanggalkeluar is NULL or b.tanggalkeluar= '0000-00-00') and b.alokasi=0 and a.unit like '".$_SESSION['empl']['lokasitugas']."%' and a.tanggal>='".$tgmulai."' and a.tanggal<='".$tgsampai."' and sistemgaji='Harian'";
...
$query6 = "select a.karyawanid,sum(a.upahpremi) as premi,sum(a.rupiahpenalty) as penalty from ".$dbname.".kebun_prestasi_vw a left join ".$dbname.".datakaryawan b on a.karyawanid=b.karyawanid where b.lokasitugas='".$_SESSION['empl']['lokasitugas']."' and  (b.tanggalkeluar>='".$tgmulai."' or b.tanggalkeluar is NULL or b.tanggalkeluar= '0000-00-00') and b.alokasi=0 and a.unit like '".$_SESSION['empl']['lokasitugas']."%' and a.tanggal>='".$tgmulai."' and a.tanggal<='".$tgsampai."' and sistemgaji='Harian'";
...
$query7 = "select a.idkaryawan as karyawanid,sum(a.premi+a.premiluarjam) as premi,sum(a.penalty) as penalty from ".$dbname.".vhc_runhk_vw a left join ".$dbname.".datakaryawan b on a.idkaryawan=b.karyawanid where b.lokasitugas='".$_SESSION['empl']['lokasitugas']."' and  (b.tanggalkeluar>='".$tgmulai."' or b.tanggalkeluar is NULL or b.tanggalkeluar= '0000-00-00') and b.alokasi=0 and substr(a.notransaksi,1,4)='".$_SESSION['empl']['lokasitugas']."' and a.tanggal>='".$tgmulai."' and a.tanggal<='".$tgsampai."' and sistemgaji='Harian' group by a.idkaryawan";
...
$query8 = "select sum(a.premiinput) as premi,a.karyawanid,a.tanggal from ".$dbname.".kebun_premikemandoran a left join ".$dbname.".datakaryawan b on a.karyawanid=b.karyawanid where b.lokasitugas='".$_SESSION['empl']['lokasitugas']."' and  (b.tanggalkeluar>='".$tgmulai."' or b.tanggalkeluar is NULL or b.tanggalkeluar= '0000-00-00') and b.alokasi=0 and a.kodeorg='".$_SESSION['empl']['lokasitugas']."' and a.tanggal like  '%".$param['periode']."%' and b.sistemgaji='Harian' and a.posting=1 group by a.karyawanid";
...
$stkh = 'select a.karyawanid,sum(a.premi+a.insentif) as premi from '.$dbname.".sdm_absensidt a left join ".$dbname.".datakaryawan b on a.karyawanid=b.karyawanid where b.lokasitugas='".$_SESSION['empl']['lokasitugas']."' and (b.tanggalkeluar>='".$tgmulai."' or b.tanggalkeluar is NULL or b.tanggalkeluar= '0000-00-00') and b.alokasi=0 and a.kodeorg like '".$_SESSION['empl']['lokasitugas']."%' and sistemgaji='Harian' and a.tanggal>='".$tgmulai."' and a.tanggal<='".$tgsampai."' group by a.karyawanid";
...
$stkh1 = 'select a.karyawanid,a.rupiahpremi  from '.$dbname.".kebun_premipanen a left join ".$dbname.".datakaryawan b on a.karyawanid=b.karyawanid where b.lokasitugas='".$_SESSION['empl']['lokasitugas']."' and  (b.tanggalkeluar>='".$tgmulai."' or b.tanggalkeluar is NULL or b.tanggalkeluar= '0000-00-00') and b.alokasi=0 and a.kodeorg like '".$_SESSION['empl']['lokasitugas']."%' and a.periode like  '%".$param['periode']."%' and sistemgaji='Harian' group by a.karyawanid";
...
$stkh = 'select a.karyawanid,sum(a.penaltykehadiran) as penaltykehadiran from '.$dbname.".sdm_absensidt a left join ".$dbname.".datakaryawan b on a.karyawanid=b.karyawanid where b.lokasitugas='".$_SESSION['empl']['lokasitugas']."' and  (b.tanggalkeluar>='".$tgmulai."' or b.tanggalkeluar is NULL or b.tanggalkeluar= '0000-00-00') and b.alokasi=0 and a.kodeorg like '".$_SESSION['empl']['lokasitugas']."%' and sistemgaji='Harian' and a.tanggal>='".$tgmulai."' and a.tanggal<='".$tgsampai."' group by a.karyawanid";
$reskh = mysql_query($stkh);
...
$query1 = selectQuery($dbname, 'datakaryawan', 'karyawanid,namakaryawan,jms,statuspajak,npwp,kodejabatan,tipekaryawan,kodegolongan,idmedical', "lokasitugas='".$_SESSION['empl']['lokasitugas']."' and (tanggalkeluar>='".$tgmulai."' or tanggalkeluar is NULL or tanggalkeluar= '0000-00-00') and alokasi=0 and sistemgaji='Harian' and ( tanggalmasuk<='".$tgsampai."' or tanggalmasuk='0000-00-00' or tanggalmasuk is null) order by karyawanid");
...
if ('KANWIL' == $tip || 'PABRIK' == $tip) {
	$str1 = 'select distinct a.*,b.namakaryawan,b.tipekaryawan,b.bagian from '.$dbname.'.sdm_5gajipokok a left join '.$dbname.'.datakaryawan b on a.karyawanid=b.karyawanid left join '.$dbname.'.kebun_kehadiran_vw c on b.karyawanid=c.karyawanid where a.tahun='.substr($tgsampai, 0, 4)." and b.lokasitugas='".$_SESSION['empl']['lokasitugas']."' and  (b.tanggalkeluar>='".$tgmulai."' or b.tanggalkeluar is NULL or b.tanggalkeluar= '0000-00-00') and b.alokasi=0 and b.sistemgaji='Harian' or c.tanggal>='".$tgmulai."' and c.tanggal<='".$tgsampai."' order by b.karyawanid,idkomponen";
} else {
	$str1 = 'select distinct a.*,b.namakaryawan,b.tipekaryawan,b.bagian from '.$dbname.'.sdm_5gajipokok a left join '.$dbname.'.datakaryawan b on a.karyawanid=b.karyawanid left join '.$dbname.'.kebun_kehadiran_vw c on b.karyawanid=c.karyawanid where a.tahun='.substr($tgsampai, 0, 4)." and b.lokasitugas='".$_SESSION['empl']['lokasitugas']."' and  (b.tanggalkeluar>='".$tgmulai."' or b.tanggalkeluar is NULL or b.tanggalkeluar= '0000-00-00') and b.alokasi=0 and b.sistemgaji='Harian' or c.tanggal>='".$tgmulai."' and c.tanggal<='".$tgsampai."' order by b.karyawanid,idkomponen";
}
...
$query3 = 'select a.nik as karyawanid,sum(jumlahpotongan) as potongan, a.tipepotongan as tipepotongan from '.$dbname.".sdm_potongandt a left join ".$dbname.".datakaryawan b on a.nik=b.karyawanid where b.tipekaryawan in(1,2,3,4,5,6) and b.lokasitugas='".$_SESSION['empl']['lokasitugas']."' and  (b.tanggalkeluar>='".$tgmulai."' or b.tanggalkeluar is NULL or b.tanggalkeluar= '0000-00-00') and b.alokasi in(0) and sistemgaji='Harian' and ".$where3.' group by a.nik';
...
if ($tip != 'kosong') {
	...
	style=\"background-color:#efc6b1;font-weight:bold\"><b>Angsuran Pinjaman</b></td>\r\n            <td style=\"background-color:#efc6b1;font-weight:bold\"><b>Angsuran Egrek</b></td>\r\n            <td 
	...
	style=\"background-color:yellow;font-weight:bold\">" . $_SESSION['lang']['gross'] . "</td>\r\n            <td 
	
	style=\"background-color:lightgrey;font-weight:bold\">" . $_SESSION['lang']['jkk'] . " (P)</td>\r\n            <td 								style=\"background-color:lightgrey;font-weight:bold\">" . $_SESSION['lang']['jkm'] . " (P)</td>\r\n            <td 
	style=\"background-color:lightgrey;font-weight:bold\">" . $_SESSION['lang']['bpjskes'] . " (P)</td>\r\n            <td 
	style=\"background-color:lightcyan;font-weight:bold\"><b>Total Gaji Bruto</b></td>\r\n            <td 
	
	style=\"background-color:#efc6b1;font-weight:bold\">" . $_SESSION['lang']['biayajabatan'] . "</td>\r\n\r\n            <td 	
	style=\"background-color:#efc6b1;font-weight:bold\">" . $_SESSION['lang']['jhtkary'] . "</td>\r\n            <td style=\"background-color:#efc6b1;font-weight:bold\">" . $_SESSION['lang']['jpkary'] . "</td>\r\n            <td 
	style=\"background-color:lightcyan;font-weight:bold\"><b>Total Netto</b></td>\r\n            <td 

	style=\"background-color:#efc6b1;font-weight:bold\">" . $_SESSION['lang']['pph21'] . "</td>\r\n            <td 
	style=\"background-color:#55fc7f;font-weight:bold\"><b>THP Bruto</b></td>\r\n            <td 

	style=\"background-color:#efc6b1;font-weight:bold\">" . $_SESSION['lang']['jhtkary'] . "</td>\r\n            <td style=\"background-color:#efc6b1;font-weight:bold\">" . $_SESSION['lang']['jpkary'] . "</td>\r\n            <td 
	style=\"background-color:#efc6b1;font-weight:bold\">" . $_SESSION['lang']['bpjskes'] . " (P)</td>\r\n            <td style=\"background-color:#55fc7f;font-weight:bold\"><b>Take Home Pay (THP)</b></td>\r\n                        </tr>\r\n                      </thead>\r\n                      <tbody>";
	
	//ini untuk kumpulkan jumlah semua per komponen gaji
	$no = 0;
			...
			if (1 == $val) {
				...
				if (2 == $val) {
					...
					if (3 == $val || 35 == $val || 36 == $val || 37 == $val || 38 == $val || 39 == $val || 40 == $val || 41 == $val || 42 == $val || 43 == $val || 44 == $val || 46 == $val || 47 == $val || 48 == $val || 49 == $val || 50 == $val || 51 == $val) {
						$id3 += $jlh; // Semua Tunjangan Golongan
					} else {
						if (4 == $val) {
							$id4 += $jlh;
						} else {
...
/*
ttlid vs komponen gaji (sdm_ho_component)
ttlid2= 24 Biaya PPH21
ttlid3= 3,35-51 tunj gol
ttlid6= 5 Pot BPJS TK (JHT) *
ttlid7= 9 Pot BPJS Pensiun *
ttlid32= 57 tunj bpjs kes
ttlid33= 8 Pot BPJS Kes *
ttlid34= 52 angs egrek (VOP)
ttlid35= 11 Angs Angkong 
ttlid36= 99
ttlid37= 64 Pot Absen (telat)/27 Pot Lain
ttlid38= 25 angs pinjaman (pot koperasi)
ttlid39= 10 Angs Karyawan (motor)
ttlid66= pot by jabatan
*/

			$ttltunjtetap = $id1 + $id2 + $id3 + $id4 + $id29 + $id15; // gapok + all tunj tetap
			$tottunjrapel = $id63 + $id58 + $id59 + $id61 + $id65 + $id60 + $id21 + $id23 + $id12 + $id62 + $id22 + $id54; // tunjangan tidak tetap
			$ttlid = $ttltunjtetap + ($id17 + $premi + $id16) + $tottunjrapel; // gapok + all tunj tetap + lembur + all premi + all tunj lain
			$totpot = $ttlid38 + $ttlid34 + $ttlid39 + $ttlid35  + $ttlid37 + $potongandenda + $potongandendapanen + $potonganbpjskes; // tot pot gross
			
			$totpotx = $ttlpotbyjab + $jhtkarypersen + $jpkarypersen + $ttlid2 + $ttlid38 + $ttlid34 + $ttlid39 + $ttlid35 + $potongandenda + 					$potongandendapanen + $potonganbpjskes;
			$totgross = $ttlid - $totpot;
			$totbruto = $totgross + $jkk + $jkm + $bpjspt;

			$totnettsebulan = $totbruto - ($ttlpotbyjab + $ttlid6 + $ttlid7); // Bruto - (By Jab + By JKK + By JKM)

			$thpbruto = $totnettsebulan - $ttlid2; // thp bruto sebulan
			//$thpnett = $thpbruto - ($ttlid38 + $ttlid34 + $ttlid39 + $ttlid35 + $ttlid37 + $ttlid33 + $ttlid6 + $ttlid7); // thp netto sebulan
			$thpnett = $thpbruto - ($ttlid6 + $ttlid7 + $potonganbpjskes); // thp netto sebulan
	...
	<input type=hidden id='komponengross" . $no . "' value='111'>\r\n    <td align=right id='totgrosstetap" . $no . "' style=\"background-color:yellow;font-weight:bold\">" . number_format($totgross, 0, ',', ',') . "</td>\r\n\r\n    
	...
	<input type=hidden id='komponentotbruto" . $no . "' value='1'>\r\n    <td align=right id='totbruto" . $no . "' style=\"background-color:lightcyan;font-weight:bold\">" . number_format($totbruto, 0, ',', ',') . "</td>\r\n\r\n    
	...
	<input type=hidden id='komponentotnettsebulan" . $no . "' value='99'>\r\n    <td align=right id='totnettsebulan" . $no . "' style=\"background-color:lightcyan;font-weight:bold\">" . number_format($totnettsebulan, 0, ',', ',') . "</td>\r\n\r\n    

	<input type=hidden id='komponenpotpph21" . $no . "' value='24'>\r\n    <td align=right id='totpotpph21" . $no . "' style=\"background-color:#efc6b1;font-weight:bold\">" . number_format($ttlid2, 0, ',', ',') . "</td>\r\n\r\n    
	<input type=hidden id='komponenthpbruto" . $no . "' value='99'>\r\n    <td align=right id='thpbruto" . $no . "' style=\"background-color:#55fc7f;font-weight:bold\">" . number_format($thpbruto, 0, ',', ',') . "</td>\r\n\r\n    

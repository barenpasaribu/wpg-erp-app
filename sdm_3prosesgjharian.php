...
$optTipe = ['kht' => 'BHT', 'khl' => 'BHL'];
$els = [];
$els[] = [makeElement('periodegaji', 'label', $_SESSION['lang']['periodegaji']), makeElement('periodegaji', 'select', '', ['style' => 'width:300px'], $optPeriod)];
...
echo open_body();
echo "<script languange=javascript1.2 src='js/sdm_prosesgjharian.js'></script>\r\n<link rel=stylesheet type=text/css href='style/zTable.css'>\r\n";

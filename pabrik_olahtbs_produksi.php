...
<tr><td>TBS Masuk</td>\r\n        <td><input type=text id=tbsmasuk onkeyup=ambilisiform()  class=myinputtextnumber style=\"width:150px;\"></td>\r\n    </tr>\r\n
...
<tr><td>Lori Olah :</td>\r\n        <td><input type=text id=loriolah onkeyup=ambilisiform()  class=myinputtextnumber style=\"width:150px;\"></td>\r\n    </tr>\r\n
<tr><td>Lori Dalam Rebusan :</td>\r\n        <td><input type=text id=loridalamrebusan onkeyup=ambilisiform()  class=myinputtextnumber style=\"width:150px;\"></td>\r\n    </tr>\r\n
<tr><td>Lori Restan Depan Rebusan :</td>\r\n        <td><input type=text id=lorirestandepanrebusan onkeyup=ambilisiform()  class=myinputtextnumber style=\"width:150px;\"></td>\r\n    </tr>\r\n
<tr><td>Lori Restan Belakang Rebusan :</td>\r\n        <td><input type=text id=lorirestanbelakangrebusan onkeyup=ambilisiform()  class=myinputtextnumber style=\"width:150px;\"></td>\r\n    </tr>\r\n
<tr><td>Estimasi Diperon:</td>\r\n        <td><input type=text id=estimasidiperon onkeyup=ambilisiform()  class=myinputtextnumber style=\"width:150px;\"></td>\r\n    </tr>\r\n
...
<tr><td>Potongan Sortasi (Kg):</td>\r\n        <td><input type=text title=press_getdata id=kgpotsortasi onkeyup=getPotsortasi()  class=myinputtextnumber style=\"width:150px;\"></td>\r\n    </tr>\r\n
<tr><td>Potongan (%):</td>\r\n        <td><input type=text id=persenpotsortasi onkeyup=ambilisiform() disabled=\"disabled\" class=myinputtextnumber style=\"width:150px;\"></td>\r\n    </tr>\r\n
<tr><td>TBS Masuk (After) :</td>\r\n        <td><input type=text id=tbsmasukafter onkeyup=ambilisiform() disabled=\"disabled\"  class=myinputtextnumber style=\"width:150px;\"></td>\r\n    </tr>\r\n
<tr><td>TBS Olah:</td>\r\n        <td><input type=text id=tbsolah onkeyup=ambilisiform() disabled=\"disabled\"  class=myinputtextnumber style=\"width:150px;\"></td>\r\n    </tr>\r\n
<tr><td>TBS Olah After:</td>\r\n        <td><input type=text id=tbsolahafter onkeyup=ambilisiform() disabled=\"disabled\"  class=myinputtextnumber style=\"width:150px;\"></td>\r\n    </tr>\r\n
<tr><td>Sisa Akhir:</td>\r\n        <td><input type=text id=sisaakhir onkeyup=ambilisiform() disabled=\"disabled\"  class=myinputtextnumber style=\"width:150px;\"></td>\r\n    </tr>\r\n
<tr></table>\r\n    <input type=hidden id=id>\r\n    <input type=hidden value='' id=notransaksi>\r\n    <button class=mybutton onclick=simpan()>".$_SESSION['lang']['save']."</button>\r\n    <button class=mybutton onclick=batal()>".$_SESSION['lang']['new']."</button>\t \r\n    </table></fieldset>";

CLOSE_BOX();

$table = 'log_transaksi_mill ORDER BY id DESC  LIMIT 0,10';
...
foreach ($result as $row) {
  ...
  //  $tables .= "<td><img id='editRow".$i."' title='Edit' onclick=\"editRow('".$row['kodeorg']."','".$row['tanggal']."','".$row['loriolah']."','".$row['loridalamrebusan']."',".$row['lorirestandepanrebusan'].", '".$row['lorirestanbelakangrebusan']."','".$row['estimasiperon']."','".$row['tbsolah']."','".$row['id']."')\"\r\n    class='zImgBtn' src='images/001_45.png' /></td>";
    ...
    $tables .= "<td>".tanggalnormal($row['tanggal'])."</td>";
    $tables .= "<td>".number_format($row['loriolah'])."</td>";
    $tables .= "<td>".number_format($row['loridalamrebusan'])."</td>";
    $tables .= "<td>".number_format($row['lorirestandepanrebusan'])."</td>";
    $tables .= "<td>".number_format($row['lorirestanbelakangrebusan'])."</td>";
    $tables .= "<td>".number_format($row['estimasidiperon'])."</td>";
    $tables .= "<td>".number_format($row['tbsolah'])."</td>";
...
var totalbuah = document.getElementById('totalbuah');
totalbuah.addEventListener('keyup', function(e)
{
	totalbuah.value = formatRupiah(this.value);
});

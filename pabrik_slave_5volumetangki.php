<?php
    ...
    switch ($param['proses']) {
        ...
        case 'loadData':
            ...
            kodeorg='".$_SESSION['empl']['lokasitugas']."' ".$whr.' order by kodeorg ASC, kodetangki ASC, tinggicm asc';
        ...
        case 'loadData2':
            ...
            $sData = 'select distinct * from '.$dbname.".pabrik_5vtangki where 
            kodeorg='".$lokasitugas."' ".$whr.' order by kodeorg ASC, kodetangki ASC, tinggicm asc';
            $qData = mysql_query($sData);
            while ($rData = mysql_fetch_assoc($qData)) {
                ++$no;
                $tab .= '<tr class=rowcontent>';

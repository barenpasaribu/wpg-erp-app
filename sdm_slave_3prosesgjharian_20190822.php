...
if (mysql_num_rows($qcekuser) > 0) {
	...
	$query1 = "SELECT a.karyawanid, nik, namakaryawan, tanggallahir, jms, firstvol, lastvol, tanggalmasuk, tanggalkeluar, statuspajak, a.npwp, kodejabatan, tipekaryawan, kodegolongan, idmedical from ".$dbname.".datakaryawan a RIGHT JOIN ".$dbname.".sdm_ho_employee b on (a.karyawanid = b.karyawanid) where tipekaryawan in(1,2,3,4,6) and lokasitugas='".$_SESSION['empl']['lokasitugas']."' and (tanggalkeluar >= '".$tanggal1."' or tanggalkeluar is NULL) and (tanggalmasuk <= '".$tanggal2."' or tanggalmasuk='0000-00-00' or tanggalmasuk is null) and alokasi=0 and sistemgaji='Harian' and a.karyawanid not in (0999999999,0888888888) order by karyawanid";
	mysql_query($query1);

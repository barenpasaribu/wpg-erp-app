...
*/
			...
			*/
			...
			if ($gabthnbln < 57.01) {
				$nilaibatasmax = 8512400; // tadinya 8094000
    ...
    foreach ($id as $key => $val) {
		...
		foreach ($readyData as $dat => $bar) {
			...
			if ($val[0] == $bar['karyawanid']) {
				...
				$totgross[$val[0]] = $totuptetap[$val[0]] + $tunjlembur[$val[0]] + $tunjpremi[$val[0]] + $tunjkom[$val[0]] + $pendapatanlain[$val[0]] + $tunjprt[$val[0]] + $tunjkehadiran[$val[0]] + $tunjair[$val[0]] + $tunjsprpart[$val[0]] + $tunjharian[$val[0]] + $tunjdinas[$val[0]] + $tunjcuti[$val[0]] + $tunjlist[$val[0]] + $tunjlain[$val[0]] + $tunjrapel[$val[0]] + $premPengawas[$val[0]]
    ...
    foreach ($id as $key => $val) {
    	...
    	$totgross[$val[0]] = 
		$totuptetap[$val[0]] + $tunjlembur[$val[0]] + $tunjpremi[$val[0]] + $premPengawas[$val[0]] + $tunjkom[$val[0]] + $pendapatanlain[$val[0]] + $tunjrt[$val[0]] + $tunjkehadiran[$val[0]] + $tunjairminum[$val[0]] + $tunjSP[$val[0]] + $tunjharian[$val[0]] + $tunjdinas[$val[0]] + $tunjcuti[$val[0]] + $tunjlistrik[$val[0]] + $tunjlain[$val[0]] + $rapelupah[$val[0]]
		-($potonganhk[$val[0]]+$potdendapanen[$val[0]]+$potongankaryawan[$val[0]]+$potongandenda[$val[0]]+$potonganlainnya[$val[0]]+$potonganegrek[$val[0]]+$potonganangkong[$val[0]]);

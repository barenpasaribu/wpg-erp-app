...
if( isset($_POST['btnSubmit']) ){
	...
	if (($handle = fopen($_FILES["fileToUpload"]["tmp_name"], 'r')) !== FALSE) { // Check the resource is valid
		...
		$content_tail = '<tr>
							<td colspan="11" ><input type="hidden" id="inputTotalData" name="inputTotalData" value="'.($counter_data-1).'" ><button type="submit" class="mybutton" name="btnSubmitData" id="btnSubmitData" onclick="clicked=\'proses\'" value="submitdata">Simpan Data</button></td>
						</tr>
						</tbody>
					</table>
				</fieldset>

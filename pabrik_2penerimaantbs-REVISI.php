...
/* $sOrg = 'SELECT a.kodecustomer, IF(ISNULL(b.namasupplier), ' ', b.namasupplier) as namasupplier from '.$dbname.".pabrik_timbangan a 
            LEFT OUTER JOIN log_5supplier b ON a.kodecustomer = b.supplierid where a.kodeorg!='' and a.millcode like '%%' group by a.kodecustomer, b.namasupplier order by a.kodecustomer"; */
...
// *------ Laporan Penerimaan TBS (Kolom 1) -----*
...
// *------ Laporan Penerimaan TBS (Kolom 2) -----*
echo "<div>\r\n<fieldset style=\"float: left;\">\r\n<legend><b>";

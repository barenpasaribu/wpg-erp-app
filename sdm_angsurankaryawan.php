...
//     where (tanggalkeluar is NULL or tanggalkeluar > '".$_SESSION['org']['period']['start']."') 
//     and alokasi=1
//     and kodeorganisasi like '".$_SESSION['empl']['kodeorganisasi']."%'
//     order by namakaryawan";
// } else {
...
//         $str1 = 's
//         elect * from '.$dbname.".datakaryawan
//         where 
//         (tanggalkeluar is NULL or tanggalkeluar > '".$_SESSION['org']['period']['start']."') 
//         and tipekaryawan!=5 
//         and lokasitugas in 
//         (select kodeunit from ".$dbname.".bgt_regional_assignment where regional='".$_SESSION['empl']['regional']."')\r\n\t and kodeorganisasi like '".$_SESSION['empl']['kodeorganisasi']."%' order by namakaryawan";
//     } else {
//         //$str1 = 'select * from '.$dbname.".datakaryawan\r\n      where (tanggalkeluar is NULL or tanggalkeluar > '".$_SESSION['org']['period']['start']."') \r\n          and tipekaryawan!=5 and LEFT(lokasitugas,4)='".substr($_SESSION['empl']['lokasitugas'], 0, 4)."'\r\n          order by namakaryawan";
        $str1 = '
        select * from '.$dbname.".datakaryawan
        where 
        (tanggalkeluar is NULL or tanggalkeluar = '0000-00-00' or tanggalkeluar > '".$_SESSION['org']['period']['start']."') 
        and kodeorganisasi like '".$_SESSION['empl']['kodeorganisasi']."%'

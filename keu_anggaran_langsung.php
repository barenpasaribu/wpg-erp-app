...
$kegiatan = [];
$els2 = [];
$els2[] = [makeElement('prosesKelompok', 'label', $_SESSION['lang']['kelompok']), makeElement('prosesKelompok', 'select', '', ['style' => 'width:200px', 'onchange' => "getKegiatan(this,'prosesKodekegiatan')", 'disabled' => 'disabled'], $kelompok)];
$els2[] = [makeElement('prosesKodekegiatan', 'label', $_SESSION['lang']['kodekegiatan']), makeElement('prosesKodekegiatan', 'select', '', ['style' => 'width:200px', 'disabled' => 'disabled'], $kegiatan)];
...
echo $headControl;
echo '</div>';
$container = "<fieldset style='float:left;clear:left;height:200px'>"."<legend><b>Header</b></legend><div id='headContainer'>";
$container .= genElement($els);
$container .= '</div></fieldset>';
$container .= "<fieldset style='float:left;clear:right;height:200px'>"."<legend><b>Proses</b></legend><div id='processContainer'>";
$container .= genElement($els2);
$container .= makeElement('autoFillBtn', 'btn', 'Proses', ['onclick' => 'autoFill()', 'disabled' => 'disabled']);
$container .= '</div></fieldset>';

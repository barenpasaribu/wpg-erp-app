...
$sData = "select distinct b.kodeorg, a.*,COALESCE(ROUND(DATEDIFF('".$tanggal1."',a.tanggaltanam)/365.25,2),0)*12 as umurbulan ".
    ...
    "and substr(b.kodeorg,1,4) like '".$kebun1."%' ";
if ($tanggal1!='') $sData.= " and a.tanggal<='".$tanggal1."' ";
echoMessage(' test ',$sData,true);

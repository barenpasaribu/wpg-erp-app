...
header("Content-Disposition: attachment; filename=Laporan Transaksi Gudang" . $_GET['unit'] .$_GET['jenis']. ".xls");
...
echo $_SESSION['lang']['transaksigudang'] . ': ' . $kamusjenis[$jenis] . ' : ' . $unit . ' : ' . $periode . ' (' . tanggalnormal($tanggalmulai) . ' - ' . tanggalnormal($tanggalsampai) . ')<br>';
if($jenis==0){
	$jenis=7;
	$movmutasi = 1;
}
...
echo  '<table class=sortable cellspacing=1 border=2 id=container>';

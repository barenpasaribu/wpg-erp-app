...
$sDtkry="select namakaryawan,karyawanid,lokasitugas, nik from ".$dbname.".datakaryawan where lokasitugas='".$_SESSION['empl']['lokasitugas']."' and (tanggalkeluar = '0000-00-00' or tanggalkeluar > ".$_SESSION['org']['period']['start']." OR ISNULL(tanggalkeluar)) and kodejabatan in (select kodejabatan from sdm_5jabatan where alias='driver') order by namakaryawan asc ";

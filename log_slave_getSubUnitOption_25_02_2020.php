...
if (isTransactionPeriod()) {
	...
	$skary = 'select a.karyawanid as nikmandor,a.namakaryawan,a.nik,a.subbagian,b.namajabatan from ' . $dbname . '.datakaryawan a ' . 'left join ' . $dbname . '.sdm_5jabatan b on a.kodejabatan=b.kodejabatan where (b.alias like \'%Mandor%\' or b.alias like \'%Asisten%\' or b.alias like \'%Kepala%\' or b.alias like \'%Admin%\') and lokasitugas=\'' . $kdunit . '\' and (tanggalkeluar is NULL or tanggalkeluar > \'' . $_SESSION['org']['period']['start'] . '\' or tanggalkeluar=\'0000-00-00\') order by a.namakaryawan asc';

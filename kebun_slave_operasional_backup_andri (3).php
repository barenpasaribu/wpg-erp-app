...
function formHeader($mode, $tipe, $data)
{
    ...
    $qKary = "select a.karyawanid,a.namakaryawan,a.nik,b.namajabatan from $dbname.datakaryawan a ".
        ...
        "where (b.namajabatan like '%Mandor%' or b.namajabatan like '%Asisten%' or ".
        "b.namajabatan like '%Kerani%' or b.namajabatan like '%Askep Estate%' or b.namajabatan like '%Admin%') and ".

...

{
...

	{
		...
		$this->Cell(190, 5, strtoupper('BERITA ACARA SERAH TERIMA BARANG [MRIS]'), 0, 1, 'C');
...
$pdf->Cell(40, 5, $_SESSION['lang']['blok'], 1, 0, 'C', 1);
$pdf->Cell(20, 5, $_SESSION['lang']['kodeblok'], 1, 1, 'C', 1);
...
while ($bar = mysql_fetch_object($res)) {
	...
	$pdf->Cell(20, 5, $kodebarang, 1, 0, 'L', 1);
	...
	$pdf->Cell(40, 5, $namaorganiasi, 1, 0, 'L', 1);
	$pdf->Cell(20, 5, $kodeblok, 1, 1, 'L', 1);

...
case 'refresh_data':
	...
	$where .= " and (";
	$where .= " if(jumlahpemberipersetujuan=1 and persetujuan1 is not null,1,0)  = 1 ";
	$where .= " or if(jumlahpemberipersetujuan=2 and persetujuan2 is not null,1,0)  = 1 ";
	$where .= " or if(jumlahpemberipersetujuan=3 and persetujuan3 is not null,1,0)  = 1 ";
	$where .= " or if(jumlahpemberipersetujuan=4 and persetujuan4 is not null,1,0)  = 1 ";
	$where .= " or if(jumlahpemberipersetujuan=5 and persetujuan5 is not null,1,0)  = 1 ";
	$where .= " ) ";
...
/*
	...
	*/
	...
	WHERE a.close >= '3' and b.status='0' and b.create_po='0' and substr(tanggal,1,4)='" . $thnSkrng . "' and SUBSTR(b.nopp, 16, 3) like '".$_SESSION['empl']['kodeorganisasi']."%'  ".$where;

...
if ($proses == 'excel' ) {
	('' === $_POST['tgl1'] ? ($tgl1 = $_GET['tgl1']) : ($tgl1 = $_GET['tgl1']));
	('' === $_POST['tgl2'] ? ($tgl2 = $_GET['tgl2']) : ($tgl2 = $_GET['tgl2']));
	('' === $_POST['status1'] ? ($status1 = $_GET['status1']) : ($status1 = $_GET['status1']));
	('' === $_POST['pt1'] ? ($pt1 = $_GET['pt1']) : ($pt1 = $_GET['pt1']));
	('' === $_POST['terima1'] ? ($terima1 = $_GET['terima1']) : ($terima1 = $_GET['terima1']));
}else{

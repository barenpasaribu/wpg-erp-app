...
function prepareQuery($param2)
{
    ...
    $sql = "select a.namaakun,o.namaorganisasi,k.*,
                (select round(sum(jumlah),2) from keu_kasbankdt k2 where k2.notransaksi=k.notransaksi) as balance,
                (case 
                ...
                left join keu_5akun a on a.noakun=k.noakun

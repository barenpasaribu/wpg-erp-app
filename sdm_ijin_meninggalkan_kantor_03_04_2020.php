...
echo "<tr>\r\n<td>Karyawan ";
echo "</td>\r\n<td>:</td>\r\n<td><select id=\"karyawanId\" name=\"karyawanId\" style=\"width:150px\">";
echo $optKarData;
echo "</select></td>\r\n</tr>\r\n\r\n";
echo "<tr>\r\n<td>".$_SESSION['lang']['jenisijin'];
echo "</td>\r\n<td>:</td>\r\n<td><select id=\"jnsIjin\" name=\"jnsIjin\" style=\"width:150px\">";
echo $optJenis;
echo "</select></td>\r\n</tr>\r\n\r\n";
echo "<tr>\r\n<td>".$_SESSION['lang']['pengabdian'].' '.$_SESSION['lang']['tahun'];
echo "</td>\r\n<td>:</td>\r\n<td><select id=\"periodec\"  style=\"width:150px\" onchange=\"loadSisaCuti(this.options[this.selectedIndex].value,";
echo $_SESSION['standard']['userid'];
echo ')">';
echo $optPeriodec;
echo "</select></td>\r\n</tr>\r\n\r\n<tr>\r\n<td>";
echo $_SESSION['lang']['dari'].'  '.$_SESSION['lang']['tanggal'].' & '.$_SESSION['lang']['jam'];
echo "</td>\r\n<td>:</td>\r\n<td><input type='text' class='myinputtext' id='tglAwal' onmousemove='setCalendar(this.id)' onkeypress='return false;'  size='10' maxlength='10' style=\"width:150px;\" /><select id=\"jam1\">";
echo $jm;
echo '</select>:<select id="mnt1">';
echo $mnt;
echo "</select></td>\r\n</tr>\r\n<tr>\r\n<td>";
echo $_SESSION['lang']['sampai'].'  '.$_SESSION['lang']['tanggal'].' & '.$_SESSION['lang']['jam'];
echo "</td>\r\n<td>:</td>\r\n<td><input type='text' class='myinputtext' id='tglEnd' onmousemove='setCalendar(this.id)' onkeypress='return false;'  size='10' maxlength='10' style=\"width:150px;\" /><select id=\"jam2\">";
echo $jm;
echo '</select>:<select id="mnt2">';
echo $mnt;
echo "</select></td>\r\n</tr>\r\n<tr>\r\n<td>";
echo $_SESSION['lang']['jumlahhk'].' '.$_SESSION['lang']['diambil'];
echo "</td>\r\n<td>:</td>\r\n<td>\r\n<input type=\"text\" class=\"myinputtext\" id=\"jumlahhk\" name=\"keperluan\" onkeypress=\"return angka_doang(event);\" maxlength=\"5\" value=\"0\"/>";
echo $_SESSION['lang']['hari'];
echo " -\r\n(";
echo $_SESSION['lang']['sisa'];
echo ':<span id="sis">';
echo $sisa.' '.$_SESSION['lang']['hari'];
echo "</span>)</td>\r\n</tr>\r\n<tr>\r\n<td>";
...
while ($rlvhc = mysql_fetch_assoc($qlvhc)) {
    ...
    echo "</td>\r\n<td>";
    echo tanggalnormald($rlvhc['darijam']);
    echo "</td>\r\n<td>";
    echo tanggalnormald($rlvhc['sampaijam']);
    echo "</td>\r\n<td>";

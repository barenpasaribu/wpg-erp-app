...
$sOpt = 'select tanggal from '.$dbname.".sdm_absensidt where kodeorg = '".$_SESSION['empl']['lokasitugas']."'"; //FA 20200609
$qOpt = mysql_query($sOpt);
while ($rOpt = mysql_fetch_assoc($qOpt)) {
...
$frm[0] .= "<fieldset>\r\n<legend><b>".$_SESSION['lang']['rkpAbsen']."</b></legend>";
...
$frm[1] .= "<fieldset>\r\n<legend><b>".$_SESSION['lang']['rkpAbsen'].' Annually</b></legend>';
...
$frm[2] .= "<fieldset>\r\n<legend><b>".$_SESSION['lang']['laporanLembur'].'</b></legend>';
...
$hfrm[0] = $_SESSION['lang']['rkpAbsen'];
$hfrm[1] = $_SESSION['lang']['rkpAbsen'].' Annually';
$hfrm[2] = $_SESSION['lang']['laporanLembur'];

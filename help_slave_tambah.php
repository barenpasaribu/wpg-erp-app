...
switch ($proses) {
    ...
    case 'deletedata':
        ...
        $sDel = 'delete from '.$dbname.'.guidance where '.$where." and kode = '".$index."'";
        if (mysql_query($sDel)) {
            echo '';
        } else {

<?php
    ...
    //-- Barang Berdasarkan kelompok barang
    ...
    $str = "select kodebarang,namabarang from $dbname.log_5masterbarang m inner join $dbname.log_5klbarang k on k.kode=m.kelompokbarang where (lower(k.alias)='vhc' OR k.alias like '%mesin%')  order by namabarang";
    $res = mysql_query($str);
    $optbarang = '';
    while ($bar = mysql_fetch_object($res)) {
    ...
    echo "<fieldset><table>\r\n 
        <tr>
            ...
            <td><select id=kelompokvhc onchange=loadJenis(this.options[this.selectedIndex].value)>'.$optklvhc."</select></td>\r\n 
        ...
        <tr>
            ...
            <td>Tgl. J/T STNK</td>
            <td><input type=text class=myinputtext id=tgljtstnk name=tgljtstnk onmousemove=\"setCalendar(this.id)\" onkeypress=\"return false\";   maxlength=10  style=width:150px; /></td>\r\n
        </tr>\r\n 
        <tr>
            <td>".$_SESSION['lang']['kodeorganisasi'].'(Owner)</td><td><select id=kodeorg onchange=getList()>'.$optorg."</select></td>\r\n
            <td>".$_SESSION['lang']['kodenopol']."</td>
            <td><input type=text id=kodevhc size=12 onkeypress=\"return tanpa_kutip_dan_sepasi(event);\" class=myinputtext maxlength=20></td>\r\n
            <td>".$_SESSION['lang']['tglakhirkir']."</td>
            <td><input type=text class=myinputtext id=tglakhirkir name=tglakhirkir onmousemove=\"setCalendar(this.id)\" onkeypress=\"return false\";   maxlength=10  style=width:150px; /></td>\r\n
        </tr>\r\n
        <tr>
            <td>".$_SESSION['lang']['namabarang']."</td>
            <td><select id=kodebarang onchange style='width:200px'>".$optbarang."</select></td>\r\n        
        ...
        <tr>
            <td></td><td></td>\r\n        
            <td>".$_SESSION['lang']['beratkosong']."</td>
            <td><input type=text id=beratkosong size=5 onkeypress=\"return angka_doang(event);\" class=myinputtextnumber maxlength=5>Kg.</td>\r\n        
            <td>".$_SESSION['lang']['tglakhirijinangkut']."</td>
            <td><input type=text class=myinputtext id=tglakhirijinang name=tglakhirijinang onmousemove=\"setCalendar(this.id)\" onkeypress=\"return false\";   maxlength=10  style=width:150px; /></td>\r\n 
        </tr>\r\n    
        <tr>
            <td>".$_SESSION['lang']['nomorrangka']."
            </td><td><input type=text id=nomorrangka size=30 onkeypress=\"return tanpa_kutip(event);\" class=myinputtextnumber maxlength=45></td>\r\n
            <td>".$_SESSION['lang']['nomormesin']."</td>
            <td><input type=text id=nomormesin size=30 onkeypress=\"return tanpa_kutip(event);\" class=myinputtextnumber maxlength=45></td>\r\n        
            <td>".$_SESSION['lang']['kodeorganisasi'].'(lokasi)</td><td><select id=kodelokasi>'.$optorg."</select></td>            \r\n\r\n
        </tr>\r\n    
        <tr>
            <td rowspan=2>".$_SESSION['lang']['tmbhDetail']."
            </td><td rowspan=2><textarea id=detailvhc cols=25 rows=2 onkeypress=\"return tanpa_kutip(event);\" maxlength=255></textarea></td>\r\n        
            <td valign=top>".$_SESSION['lang']['kepemilikan'].'
            </td><td valign=top><select id=kepemilikan>'.$optkepemilikan."</select></td>\r\n    
        </tr>\r\n    
        <tr>\r\n        
            <td>".$_SESSION['lang']['kodetraksi'].'</td><td><select id=kodetraksi>'.$opttraksi."</select></td>\r\n    
        </tr>\r\n    
        </table>\r\n\t <input type=hidden id=method value='insert'>\r\n\t <button class=mybutton onclick=simpanMasterVhc()>".$_SESSION['lang']['save']."
    ...
    while ($bar1 = mysql_fetch_object($res1)) {
        ...
        echo '<tr '.$bgcrcolor.">\r\n\t\t     
            ...
            <td>\r\n\t\t\t     
            <img src=images/application/application_edit.png class=resicon  caption='Edit' onclick=\"fillMasterField('".
                $bar1->kodeorg."','".
                $bar1->kelompokvhc."','".
                $bar1->jenisvhc."','".
                $bar1->kodevhc."','".
                ...
                $bar1->kepemilikan."','".
                $bar1->kodetraksi."','".
                tanggalnormal($bar1->tgljtstnk)."','".
                tanggalnormal($bar1->tglakhirstnk)."','".
                tanggalnormal($bar1->tglakhirkir)."','".
                tanggalnormal($bar1->tglakhirijinbm)."','".
                tanggalnormal($bar1->tglakhirijinang)."','".
                $bar1->kodelokasi."','".$bar1->detailvhc."');\">\r\n\t\t\t

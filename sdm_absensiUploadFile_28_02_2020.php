		...
		*/
		...
		while ($res = mysql_fetch_array($hasil)) { 
			...
			*/
			...
			// print_r("tes");
			// print_r($wkt_lembur_hari_normal_aktual);
			// print_r($lembur_hari_normal);
			// print_r($lembur_akhir_pekan);
			// print_r($wkt_lembur_akhir_pekan_aktual);
			// print_r($lembur_hari_libur);
			// print_r($wkt_lembur_hari_libur_aktual);

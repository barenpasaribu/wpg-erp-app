...
if ('HOLDING' === $_SESSION['empl']['tipelokasitugas'] || 'KANWIL' === $_SESSION['empl']['tipelokasitugas']) {
    ...
    $whr = 'kodeorganisasi in(select distinct kodeunit from '.$dbname.".bgt_regional_assignment where regional='".$ckRegional[$_SESSION['empl']['lokasitugas']]."' AND kodeunit like '".$_SESSION['org']['kodeorganisasi']."%')";

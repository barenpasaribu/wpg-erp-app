...
switch ($proses) {
    ...
    case 'showEdit':
		...
		."' and kodeorg='".$param['kodeorg']."' and noakun='".$param['noakun']."' and tipetransaksi='".$param['tipetransaksi']."'");
    ...
    case 'add':
        ...
        if ($data['hutangunit'] == 1 && ($data['pemilikhutang'] == '' || $data['noakunhutang'] == '')) {

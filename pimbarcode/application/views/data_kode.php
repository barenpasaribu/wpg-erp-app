	  ...
	  <div class="card">
                            <div class="card-body">
								...
								foreach ($field as $t) { ?>
									<tr>
										<th><?php echo $no++;?></th>
										<th><?php echo $t['FIELDNO'];?></th>
										<th>
											<a onclick="openReceipt('<?=base_url()?>kodeblok/cetak_barcode?pcode=<?php echo $t['FIELDNO']; ?>')" style="text-decoration: none; cursor: pointer;" title="Print Barcode">

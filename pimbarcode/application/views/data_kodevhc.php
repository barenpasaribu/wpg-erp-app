 ...
 <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Daftar Data Kode Vhc</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">KodeVhck</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Daftar Data kode vhc</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-12">
					 <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Data Kode vhc</h5>
								...
								foreach ($kendaraan as $t) { ?>
									<tr>
										<th><?php echo $no++;?></th>
										<th><?php echo $t['KENDNO'];?></th>
                                        <th><?php echo $t['REGNO'];?></th>
										<th>
											<a onclick="openReceipt('<?=base_url()?>kodevhc/cetak_barcode?pcode=<?php echo $t['KENDNO']; ?>')" style="text-decoration: none; cursor: pointer;" title="Print Barcode">

...
switch ($proses) {
    ...
    case 'showList':
        ...
        break;
    case 'editHeader':
        $where = "kodeanggaran='".$_POST['kodeanggaran']."' and tahun=".$_POST['tahun']." and kodeorg='".$_POST['kodeorg']."' and revisi=".$_POST['revisi'];
    ...
    case 'edit':
        ...
        $where = "kodeanggaran='".$data['kodeanggaran']."' AND "."kodeorg='".$data['kodeorg']."' AND "."tahun='".$data['tahun']."' AND revisi=".$data['revisi'];

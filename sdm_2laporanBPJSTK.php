...
*/
	OPEN_BOX_HRD('','<b>'.$_SESSION['lang']['lapbpjstk'].'</b>');
		echo"<div id=EList>";
		//echo OPEN_THEME_HRD('JAMSOSTEK:');
        echo"<br>
		      ".$_SESSION['lang']['periode'].":<select id=bln name=bln onchange=getBPJSTKVal(this.options[this.selectedIndex].value)><option value=''></option>".$opt3."</select>
			 ";

		echo"<hr><br>".$_SESSION['lang']['lapbpjstk']." ".$_SESSION['lang']['periode'].":<b><span id=caption>".$bln."</span></b>
			  <img src=images/excel.jpg height=17px style='cursor:pointer;' onclick=convertBPJSTKExcel()>

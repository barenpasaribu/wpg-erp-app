...
echo $_SESSION['lang']['budget'] . ' ' . $_SESSION['lang']['detail'];
...
echo $optOrg;
echo '</select></td></tr>' . "\r\n" . '<tr height="20"><td colspan="2">&nbsp;</td></tr>' . "\r\n" . '<tr><td colspan="2"><!--<button onclick="zPreview(\'bgt_slave_laporan_detail\',\'';
echo $arr;
echo '\',\'printContainer\')" class="mybutton" name="preview" id="preview">Preview</button>' . "\r\n" . '                    <button onclick="zPdf(\'bgt_slave_laporan_detail\',\'';
echo $arr;
echo '\',\'printContainer\')" class="mybutton" name="preview" id="preview">PDF</button>' . "\r\n" . '                    --><button onclick="zExcel(event,\'bgt_slave_laporan_detail.php\',\'';
echo $arr;

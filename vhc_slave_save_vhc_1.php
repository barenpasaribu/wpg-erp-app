...
$kelompokvhc=$param['kelompokvhc'];
$jenisvhc=$param['jenisvhc'];
$kodeorg=$param['kodeorg'];
$method=$param['method'];
$kodevhc=str_replace(" ","",$v['kodevhc']);
$tahunperolehan=$param['tahunperolehan'];
$noakun=$param['noakun'];
$beratkosong=$param['beratkosong'];
$nomorrangka=$param['nomorrangka'];
$nomormesin=$v['nomormesin'];
$detailvhc=$param['detailvhc'];
$kodebarang=$param['kodebarang'];
$kepemilikan=$param['kepemilikan'];
$kodetraksi=$param['kodetraksi'];
$tglakhirstnk=tanggalsystem($param['tglakhirstnk']);
$tglakhirkir=tanggalsystem($param['tglakhirkir']);
$tglakhirijinbm=tanggalsystem($param['tglakhirijinbm']);
$tglakhirijinang=tanggalsystem($param['tglakhirijinang']);
		...
		echo"<tr ".$bgcrcolor.">
			 ...
			 <td>
			      <img src=images/application/application_edit.png class=resicon  caption='Edit' onclick=\"fillMasterField('".$bar1->kodeorg."','".$bar1->kelompokvhc."','".$bar1->jenisvhc."','".$bar1->kodevhc."','".$bar1->beratkosong."',
                                 ...
                                 '".tanggalnormal($bar1->tglakhirijinbm)."','".tanggalnormal($bar1->tglakhirijinang)."');\">

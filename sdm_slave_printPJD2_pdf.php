...
$pdf->Cell(50, 5, ' : '.$tanggalperjalanan . " / Jam Berangkat : ", 0, 1, 'L');
$pdf->SetX(20);
$pdf->Cell(30, 5, $_SESSION['lang']['tanggalkembali'], 0, 0, 'L');
$pdf->Cell(50, 5, ' : '.$tanggalkembali . " / Jam Kembali : ", 0, 1, 'L');
$pdf->Ln();
$pdf->SetX(20);
...
$pdf->Cell(80, 5, strtoupper($_SESSION['lang']['tugas']), 1, 0, 'C');
$pdf->Cell(20, 5, "Jam Datang", 1, 0, 'C');
$pdf->Cell(20, 5, "Jam Pulang", 1, 1, 'C');
$pdf->SetFont('Arial', '', 8);
...
$xPos=$pdf->GetX();
$yPos=$pdf->GetY();
$pdf->MultiCell(80, 5, $tugas1, 1);
$pdf->SetXY($xPos + $cellWidth , $yPos);
$pdf->Cell(20,(5*$line), "", 1, 0);
$pdf->Cell(20,(5*$line), "", 1, 1);
...
if($pdf->GetStringWidth($tugaslain) < $cellWidth){
$pdf->Cell(80,(5*$line), $tugaslain, 1);
}else{
$pdf->MultiCell(80,5, $tugaslain, 1);    
}
...
$pdf->Cell(50, 5, $_SESSION['lang']['verifikasi'], 0, 0, 'C');
$pdf->Cell(50, 5, $_SESSION['lang']['verifikasi'], 0, 0, 'C');
$pdf->Cell(50, 5, $_SESSION['lang']['verifikasi'], 0, 0, 'C');
$pdf->Cell(50, 5, $_SESSION['lang']['verifikasi'], 0, 1, 'C');

if (empty($tujuan1)) {
    $pdf->Cell(50, 5, "(                )", 0, 0, 'C');
}else{
    $pdf->Cell(50, 5, "( ".$tujuan1." )", 0, 0, 'C');
}
if (empty($tujuan2)) {
    $pdf->Cell(50, 5, "(                )", 0, 0, 'C');
}else{
    $pdf->Cell(50, 5, "( ".$tujuan2." )", 0, 0, 'C');
}
if (empty($tujuan3)) {
    $pdf->Cell(50, 5, "(                )", 0, 0, 'C');
}else{
    $pdf->Cell(50, 5, "( ".$tujuan3." )", 0, 0, 'C');
}
if (empty($tujuanlain)) {
    $pdf->Cell(50, 5, "(                )", 0, 1, 'C');
}else{
    $pdf->Cell(50, 5, "( ".substr($tujuanlain,0,25)." )", 0, 1, 'C');
}
$pdf->Ln();
$pdf->Ln();
$pdf->Ln();

...
"<script languange=javascript1.2 src='js/zTools.js". "?v=".mt_rand()."'></script> ".
"<script language=javascript1.2 src='js/keu_kasbank.js". "?v=".mt_rand()."'></script> ".
...
$ctl[] = '<fieldset ><legend><b>'.$_SESSION['lang']['find'].'</b></legend>'.
    ...
    makeElement('sAkun', 'select', '', [], $optAkun).
    ...
    makeElement('sSup', 'text', '').
    makeElement('sFind', 'btn', $_SESSION['lang']['find'], ['onclick' => 'newGoToPages(1,'.SHOW_ROW_COUNT.')']).'</fieldset>';
...
//$sql.= "  limit 0,10" ;
//echo generateTable($sql,$page,$totalRow);
CLOSE_BOX();
OPEN_BOX();
echo "<div id='workField'>";
echo generateTable('',10,0);

...
if (mysql_num_rows($qcekuser) > 0) {
	...
	// cek apakah periode penggajian sudah tutup
	...
	// cek apakah periode akuntansi sudah tutup
	...
	// ambil tanggal mulai dan tanggal akhir periode gajian
	...
	// cek apakah ada data absensi di periode penggajian ini
	...
	$where2 = " and substr(kodeorg,1,4)='".$_SESSION['empl']['lokasitugas']."'";
	$where3 = " and a.sistemgaji = 'Harian' ";

    $squery2 = "SELECT b.karyawanid as karyawanid, sum(b.uangkelebihanjam)) as lembur FROM ".$dbname.".sdm_lemburdt LEFT JOIN ".$dbname.".datakaryawan a on a.karyawanid = b.karyawanid WHERE b.tanggal between  '".$tanggal1."' and '".$tanggal2."' ".$where2.' '.$where3.' and b.uangkelebihanjam>0 group by a.karyawanid';
/*
    $where2 = " a.kodeorg like '".$_SESSION['empl']['lokasitugas']."%' and tanggal between '".$tanggal1."' and '".$tanggal2."'";
...
*/
	...
	// cek apakah masih ada data yg belum dialokasikan
...
*/
	...
	// ini seeprtinya gak dipakai - FA 20190317
    ...
    $list0 .= '<td style="background-color:lightblue;font-weight:bold">Premi</td>';
    ...
    foreach ($id as $key => $val) {
        ...
        $totgross[$val[0]] = $totuptetap[$val[0]] + $tunjlembur[$val[0]] + $tunjpremi[$val[0]] + $tunjkom[$val[0]] + $tunjlok[$val[0]] + $tunjrt[$val[0]] + $tunjbbm[$val[0]] + $tunjairminum[$val[0]] + $tunjSP[$val[0]] + $tunjharian[$val[0]] + $tunjdinas[$val[0]] + $tunjcuti[$val[0]] + $tunjlistrik[$val[0]] + $tunjlain[$val[0]] + $rapelupah[$val[0]];
        ...
        $thpbruto[$val[0]] = $gjnettosebulan[$val[0]] - $pphSetahun[$val[0]];

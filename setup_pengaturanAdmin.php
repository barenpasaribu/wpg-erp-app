...
switch ($proses) {
    case "init":
        ...
        $getKaryawanBHL = "SELECT * FROM sdm_5tipekaryawan WHERE isharian = '1'";
        ...
        WHERE 
            NOT (karyawanid IN (SELECT karyawanid FROM user))
        AND 
            isduplicate = 0 
        AND 
            (tanggalkeluar IS NULL OR tanggalkeluar = '0000-00-00')
        AND 

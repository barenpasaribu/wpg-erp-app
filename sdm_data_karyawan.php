...
$frm[1] = ' <fieldset>
                <legend>' . $_SESSION['lang']['pengalamankerja'] . "</legend>
                <table border=0 cellspacing=1>
                    <tr>
...
$frm[6] = ' <fieldset>
                <legend>' . $_SESSION['lang']['alamat'] . "</legend>
                <table border=0 cellspacing=1>
                    <tr>
                        <td align=right rowspan=2>" . $_SESSION['lang']['alamat'] . "</td>
                        <td rowspan=2>
                            <textarea id=alamatalamat cols=19 rows=2 onkeypress=\"return tanpa_kutip(event);\">
                            </textarea><img src=images/obl.png title='Obligatory'></td>\r\n                    <td align=right>" . $_SESSION['lang']['kota'] . "</td><td><input type=text class=myinputtext id=alamatkota size=30 maxlength=45 onkeypress=\"return tanpa_kutip(event);\"></td>\r\n                 </tr>\r\n                 <tr>\r\n                        <td align=right>" . $_SESSION['lang']['province'] . "</td><td><select id=alamatprovinsi style='width:170px;'>" . $optProvinsi . "</select></td>\r\n                 </tr>\r\n                 <tr>\r\n                    <td align=right>" . $_SESSION['lang']['kodepos'] . "</td><td><input type=text class=myinputtext id=alamatkodepos size=30  maxlength=5 onkeypress=\"return angka_doang(event);\"></td>\r\n                        <td align=right>" . $_SESSION['lang']['telp'] . "</td><td><input type=text class=myinputtext id=alamattelepon size=30  maxlength=15 onkeypress=\"return tanpa_kutip(event);\"></td>\r\n                 </tr>\r\n                 <tr>\r\n                    <td align=right>" . $_SESSION['lang']['emplasmen'] . "</td><td><input type=text class=myinputtext id=alamatemplasement size=30  maxlength=45 onkeypress=\"return tanpa_kutip(event);\"></td>\r\n                        <td align=right>" . $_SESSION['lang']['alamataktif'] . "</td><td colspan=3><select id=alamatstatus  style='width:170px;'><option value='0'>" . $_SESSION['lang']['no'] . "</option><option value='1'>" . $_SESSION['lang']['yes'] . "</option></select></td>\r\n                 </tr>\r\n                 </table>\r\n                 </fieldset>\r\n                 <button id=btnalamat disabled class=mybutton onclick=simpanAlamat()>" . $_SESSION['lang']['save'] . "</button>\r\n                <br>\r\n                <br>\r\n                <div style='width:100%;height:250px;overflow:scroll;'>\r\n                <table class=sortable border=0 cellspacing=1 width=100%>\r\n                        <thead>\r\n                        <tr class=rowheader>\r\n                          <td>No.</td>\r\n                          <td>" . $_SESSION['lang']['alamat'] . "</td>\r\n                          <td>" . $_SESSION['lang']['kota'] . "</td>\r\n                          <td>" . $_SESSION['lang']['province'] . "</td>\r\n                          <td>" . $_SESSION['lang']['kodepos'] . "</td>\r\n                          <td>" . $_SESSION['lang']['emplasmen'] . "</td>\r\n                          <td>" . $_SESSION['lang']['status'] . "</td>\r\n                          <td></td>\r\n                        </tr>\r\n                        </thead>\r\n                        <tbody id=containeralamat>\r\n                        </tbody>\r\n                        <tfoot>\r\n                        </tfoot>\r\n                </table>\r\n                </div>\r\n                ";
$frm[7] = ' <fieldset>
                <legend>' . $_SESSION['lang']['pengalamankerja'] . "</legend>
                <table border=0 cellspacing=1>
                    <tr>
                        <td align=right>Nama Perusahaan</td>
                        <td><input type=text class=myinputtext id=kontrak_nama_perusahaan size=30 maxlength=45 onkeypress=\"return tanpa_kutip(event);\">
                            <img src=images/obl.png title='Obligatory'>
                        </td>
                        <td align=right>" . $_SESSION['lang']['bidangusaha'] . "</td>
                        <td><input type=text class=myinputtext id=kontrak_bidang_usaha size=30 maxlength=45 onkeypress=\"return tanpa_kutip(event);\"></td>
                    </tr>
                    <tr>
                        <td align=right>Tanggal Mulai Kontrak</td>
                        <td>
                            <input type=text id=tanggal_mulai_kontrak size=10 maxlength=10 class=myinputtext onkeypress=\"return false;\" onmouseover=setCalendar(this)>
                        </td>
                        <td align=right>Tanggal Berakhir Kontrak</td>
                        <td>
                        <input type=text id=tanggal_selesai_kontrak size=10 maxlength=10 class=myinputtext onkeypress=\"return false;\" onmouseover=setCalendar(this)>
                        </td>
                    </tr>
                    <tr>
                        <td align=right>Jabatan</td>
                        <td>
                            <input type=text class=myinputtext id=kontrak_jabatan size=30 maxlength=45 onkeypress=\"return tanpa_kutip(event);\">
                        </td>
                        <td align=right>" . $_SESSION['lang']['bagian'] . "</td>
                        <td>
                            <input type=text class=myinputtext id=kontrak_bagian size=30 maxlength=45 onkeypress=\"return tanpa_kutip(event);\">
                            <img src=images/obl.png title='Obligatory'>
                        </td>
                    </tr>
                    <tr>
                        <td align=right>" . $_SESSION['lang']['alamat'] . "</td>
                        <td colspan=4>
                            <textarea id=kontrak_alamat cols=19 rows=2 onkeypress=\"return tanpa_kutip(event);\"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td align=right>Tipe Karyawan</td>
                        <td>
                            <select id=kontrak_tipe_karyawan  style='width:170px;'>
                                " . $opttipekaryawan . "
                            </select>
                        </td>
                    </tr>
                    <tr>
                        <td align=right>Status Cuti (Awal Kontrak)</td>
                        <td>
                            <select id=kontrak_status_cuti  style='width:170px;'>
                                <option value=0>Tidak dapat cuti</option>
                                <option value=1>Dapat cuti</option>
                            </select>
                        </td>
                    </tr>
                </table>
            </fieldset>
            <button id=btnkontrak disabled class=mybutton onclick=simpanKontrak()>" . $_SESSION['lang']['save'] . "</button>
            <br>
            <div style='width:100%;height:250px;overflow:scroll;'>
            <table class=sortable border=0 cellspacing=1 width=100%>
            <thead>
            ...
            <tbody id=kontrakcontainer></tbody>
            <tfoot></tfoot>
        </table>           
    </div>";
$str = 'select kelompok,levelpendidikan from ' . $dbname . '.sdm_5pendidikan order by levelpendidikan';

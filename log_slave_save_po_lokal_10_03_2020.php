...
*/
	...
	//insert ke log_poht 
	$sql_insert = "insert into ".$dbname.".log_poht(kodeorg,nopo,tanggal,kodesupplier,subtotal,diskonpersen,nilaidiskon,ppn,nilaipo,tanggalkirim,".$field.",syaratbayar,uraian,lokalpusat,matauang,kurs,persetujuan1,hasilpersetujuan1,tglp1,statuspo,persetujuan2,hasilpersetujuan2,tglp2,tgledit,ongkosangkutan,miscppn,misc,ongkirimppn,statusbayar,updateby,purchaser,po_lokal) 
	values('".$_SESSION['empl']['kodeorganisasi']."','".$nopo."','".$thisDate."','".$supplier_id."','".$sub_total."','".$disc."','".$nilai_dis."','".$nppn."','".$nilai_po."','".$tanggl_kirim."','".$lokasi_kirim."','".$cr_pembayaran."','".$ketUraian."','0','".$mtUang."','".$Kurs."','".$persetujuan."','1','".$thisDate."','2','0','1','".$thisDate."','".$thisDate."','".$ongkirim."','".$_POST['miscppn']."','".$_POST['misc']."','".$ppnongkirim."','".$_POST['crByr']."','".$_SESSION['standard']['userid']."','".$purchaser."','Y')";
	if (!mysql_query($sql_insert)) {
		$Ok= $Ok+2;

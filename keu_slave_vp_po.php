...
switch ($proses) {
	case 'po':
		...
		switch ($param['tipe']) {
			case 'p':
				...
				$query = "select 'PO',nopo,kodeorg,namasupplier from keu_tagihanht a inner join log_5supplier b on a.kodesupplier=b.supplierid where nopo like '%".$param['po']."%' and posting=1 and tipeinvoice='p' and kodeorg='".$ptTugas."' ";
			...
			case 'k':
				...
				$query = "select 'Kontrak',nopo,kodeorg,namasupplier from keu_tagihanht a inner join log_5supplier b on a.kodesupplier=b.supplierid where nopo like '%" . $param['po'] . "%' and posting=1 and tipeinvoice='k' and kodeorg='".$ptTugas."' ";
			...
			case 's':
				...
				$query = "select 'Surat Jalan',nopo,kodeorg,namasupplier from keu_tagihanht a inner join log_5supplier b on a.kodesupplier=b.supplierid where nopo like '%" . $param['po'] . "%' and posting=1  and tipeinvoice='s' and kodeorg='".$ptTugas."' ";
				break;
			case 'n':
				...
				$query = "select 'Konosemen',nopo,kodeorg,namasupplier from keu_tagihanht a inner join log_5supplier b on a.kodesupplier=b.supplierid where nopo like '%" . $param['po'] . "%' and posting=1  and tipeinvoice='n' and kodeorg='".$ptTugas."' ";
			...
			case 'o':
				...
				$query = "select 'Other',nopo,kodeorg,namasupplier from keu_tagihanht a inner join log_5supplier b on a.kodesupplier=b.supplierid where nopo like '%" . $param['po'] . "%' and posting=1  and tipeinvoice='o' and kodeorg='".$ptTugas."' ";
			...
			case 'f':
				...
				$query = "select 'Fee',nopo,kodeorg,namasupplier from keu_tagihanht a inner join log_5supplier b on a.kodesupplier=b.supplierid where nopo like '%" . $param['po'] . "%' and posting=1  and tipeinvoice='f' and kodeorg='".$ptTugas."' ";

				break;
			case 'b':
				$title = 'Batch';
				$query = "select 'Batch',a.nobatch,kodeorg, namasupplier from keu_batchht a inner join keu_batchdt b on a.nobatch=b.nobatch left join log_5supplier c on b.kodesupplier=c.supplierid where a.nobatch like '" . $_SESSION['org']['kodeorganisasi'] . "%' and a.status=0 GROUP BY a.nobatch";

	//			$query = "select 'Batch',nopo,kodeorg,namasupplier from keu_tagihanht a inner join log_5supplier b on a.kodesupplier=b.supplierid where nobatch like '" . $_SESSION['org']['kodeorganisasi'] . "%' and status=0 ";
		...
		$page .= '<td>' . $title . '</td><td>' . $_SESSION['lang']['kodeorganisasi'] . '</td><td>Supplier</td></tr></thead>';
		$page .= '<tbody>';
	...
	case 'batch':
		$page='';
		$btnsave='';
		$kodept=substr($_SESSION['empl']['lokasitugas'],0,3);
		if ($proses=='batch') {
			$sql = "select
			...
			$query = selectQuery($dbname, 'keu_tagihanht', '*', 'nopo=\'' . $param['po'] . '\' and tipeinvoice=\'' . $param['tipe'] . '\' and kodeorg=\'' . $kodept . '\' ');
			//saveLog($query);
			$data = fetchData($query);

...
$proses = $_GET['proses'];
$periode = $_POST['periodeTahun'];
$kdBrg = $_POST['kdBrgTahun'];
$idPabrik = $_POST['idPabrikTahun'];
$idPelanggan = $_POST['idPelangganTahun'];
...
case 'pdf':
	...
	$periode = $_GET['periodeTahun'];
	$kdBrg = $_GET['kdBrgTahun'];
	$idPabrik = $_GET['idPabrikTahun'];
	$idPelanggan = $_GET['idPelangganTahun'];
	...
	$pdf->SetFont('Arial', '', 7);
	$sDet = 'select nokontrak,kodebarang,tanggalkontrak,koderekanan,tanggalkirim,kuantitaskontrak,kodept,hargasatuan,matauang  from ' . $dbname . '.pmn_kontrakjual where tanggalkontrak like \'' . $periode . '-%\' and kodebarang=\'' . $kdBrg . '\' and kodept=\'' . $idPabrik . '\' ';
	if(trim($idPelanggan) != ""){
		$sDet .= " and koderekanan='".$idPelanggan."' ";
	}
	$sDet .= 'order by tanggalkontrak asc';
...
case 'excel':
	...
	$strx = 'select nokontrak,kodebarang,tanggalkontrak,koderekanan,tanggalkirim,kuantitaskontrak,kodept,hargasatuan,matauang  from ' . $dbname . '.pmn_kontrakjual where tanggalkontrak like \'' . $periode . '-%\' and kodebarang=\'' . $kdBrg . '\' and kodept=\'' . $idPabrik . '\' ';
	if(trim($idPelanggan) != ""){
		$strx .= " and koderekanan='".$idPelanggan."' ";
	}
	$strx .= 'order by tanggalkontrak asc';

...
OPEN_BOX();
echo '<link rel=stylesheet type=text/css href="style/zTable.css">' . "\r\n" . '<script language="javascript" src="js/zMaster.js"></script>' . "\r\n" . '<script type="text/javascript" src="js/log_po_langsung.js?v='.date('YmdHis').'"></script>';
...
echo 'Cari No.POL:<input type=text id=txtsearch size=25 maxlength=30 onkeypress="return validat(event);" class=myinputtext>';

...
function createTabDetail($id, $data)
{
	...
	'<td colspan=7 align=right>' . $_SESSION['lang']['diskon'] . ' (%)</td>' . "\n" . '            <td><input type=text  id=\'diskon\' name=\'diskon\' class=\'myinputtext\' style=\'width:100px\' onkeyup=\'calculate_diskon()\' maxlength=\'3\' onkeypress=\'return angka_doang(event)\' onblur="getZero()" /> </td>' . "\n" . '        </tr>' . "\n" . '        <tr>' . "\n" . '            <td>&nbsp;</td>' . "\n" .
	'<td colspan=7 align=right>PPn (%)</td>
		<td>
			<input type=text id=\'ppN\' name=\'ppN\'  class=\'myinputtext\' style=\'width:100px\' onkeyup=\'calculatePpn()\'  maxlength=\'2\'  onkeypress=\'return angka_doang(event)\' onblur="getZero()" />  
		</td>
	</tr>
	<tr><td>&nbsp;</td>
	<td colspan=7 align=right>Nilai PPn</td>
		<td>
			<input type=\'text\' id=\'ppn\' name=\'ppn\' class=\'myinputtextnumber\' style=\'width:100px\' onkeyup=\'calculateMiscPpn(0)\'  onkeypress=\'return angka_doang(event)\' onblur="getZero()" />
			<span id=\'hslPPn\'> </span> 
		</td>
	</tr>
	<tr>
		...
		<td><input type=text id=\'ppH\' name=\'ppH\'  class=\'myinputtext\' style=\'width:100px\' onkeyup=\'calculatePph()\'  maxlength=\'2\'  onkeypress=\'return angka_doang(event)\' onblur="getZero()" /> 
	</tr>
		<tr>
		<td>&nbsp;</td>
		<td colspan=7 align=right>Nilai PPh</td>
		<td> <input type=\'text\' id=\'pph\' name=\'pph\' class=\'myinputtextnumber\' onkeypress=\'return angka_doang(event)\' style=\'width:100px\' onblur="getZero()" onkeyup=\'calculateMiscPpn(0)\' /><span id=\'hslPPh\'> </span> </td>
	</tr>
	<tr>
		<td>&nbsp;</td>

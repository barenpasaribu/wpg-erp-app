...
echo $_SESSION['lang']['rPengiriman'];
...
echo $arr;
echo "','printContainer')\" class=\"mybutton\" name=\"preview\" id=\"preview\">Preview</button><button onclick=\"zPdf('pabrik_slave_2pengiriman','";
echo $arr;
echo "','printContainer')\" class=\"mybutton\" name=\"preview\" id=\"preview\">PDF</button><button onclick=\"zExcel(event,'pabrik_slave_2pengiriman.php','";
echo $arr;

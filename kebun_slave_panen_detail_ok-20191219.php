...
switch ($proses) {
    ...
    case 'updUpah':
        ...
        */
		...
		$metode= 0; // untuk cek metode apakah 

		// Khusus CDS, metode = 1, semua hasil kerja digabung menjadi 1
		...
		if ($rows['metode']==1 && $tothasilkerja>0) {
			$isgabunghasil = 3; // untuk blok kedua, jika blok pertama sdh dpt basis dan PN2
            $isDobel = 1;
			$tothasilkerja = $hasilKg;
		}
                                    ...
                                    */
									...
									if ($isgabunghasil == 3) {
										...
										from kebun_5premipanen where kebun_5premipanen.hasilpanen > ".$batasatas
											...
											"kodeorg='".$paramBlok."') order by rupiah desc limit 1";
									}
									$qstr = mysql_query($str);
                                    while ($rows = mysql_fetch_assoc($qstr)) {

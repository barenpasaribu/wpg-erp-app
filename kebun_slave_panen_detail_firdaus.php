...
switch ($proses) {
    case 'showDetail':
        ...
        $whereKary = "(lokasitugas='".$_SESSION['empl']['lokasitugas']."' and "."tipekaryawan in (3,4) and kodejabatan=48)";
		//FA-20190923
		//LSP: 48=Harvester
        ...
        $theForm2->_elements[21]->_attr['onblur'] = "updDenda('JT');";
        $theForm2->_elements[22]->_attr['onblur'] = "updDenda('BT');";
        $theForm2->_elements[23]->_attr['onblur'] = "updDenda('PT');";
        $theForm2->_elements[24]->_attr['onblur'] = "updDenda('TM');";
...
*/
    ...
    case 'updUpah':
        ...
        $regData = $param['blok']; //FA-20190923

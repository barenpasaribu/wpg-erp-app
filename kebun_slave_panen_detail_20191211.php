...
switch ($proses) {
    ...
    <fieldset>
		...
		//<td><img src='images/skyblue/edit.png' class='zImgBtn' onclick=\"var data = ".$rowdata."; showDetailData(data);\" title='Edit'></td>
            ...
            <td id='head_norma' align='center' style='width:100px'>".number_format($row['norma'],2)."</td>
            <td id='head_hasilkerja' align='center' style='width:100px'>".number_format($row['hasilkerja'],2)."</td>
            <td id='head_brondolan' align='center' style='width:100px'>".number_format($row['brondolan'],2)."</td>
            <td id='head_hasilkerjakg' align='center' style='width:120px'>".number_format($row['hasilkerjakg'],2)."</td>
            <td id='head_jumlahlbhbasis' align='center' style='width:120px'>".number_format($row['jumlahlbhbasis'],2)."</td>
            <td id='head_umr' align='center' style='width:120px'>".number_format($row['umr'],2)."</td>
            <td id='head_premilebihbasis' align='center' style='width:120px'>".number_format($row['premilebihbasis'],2)."</td>
            <td id='head_premihadir' align='center' style='width:120px'>".number_format($row['premihadir'],2)."</td>
            <td id='head_premirajin' align='center' style='width:120px'>".number_format($row['premirajin'],2)."</td>
            <td id='head_premibrondol' align='center' style='width:120px'>".number_format($row['premibrondol'],2)."</td>
            <td id='head_upahpremi' align='center' style='width:120px'>".number_format($row['upahpremi'],2)."</td>
            <td id='head_upahkerja' align='center' style='width:120px'>".number_format($row['upahkerja'],2)."</td>
            <td id='head_penalti1' align='center' style='width:100px'>".number_format($row['penalti1'],2)."</td>
            <td id='head_penalti2' align='center' style='width:100px'>".number_format($row['penalti2'],2)."</td>
            <td id='head_penalti3' align='center' style='width:100px'>".number_format($row['penalti3'],2)."</td>
            <td id='head_penalti4' align='center' style='width:100px'>".number_format($row['penalti4'],2)."</td>
            <td id='head_penalti5' align='center' style='width:100px'>".number_format($row['penalti5'],2)."</td>
            <td id='head_penalti6' align='center' style='width:100px'>".number_format($row['penalti6'],2)."</td>
            <td id='head_penalti7' align='center' style='width:100px'>".number_format($row['penalti7'],2)."</td>
            <td id='head_rupiahpenalty' align='center' style='width:100px'>".number_format($row['rupiahpenalty'],2)."</td>
            <td id='head_luaspanen' align='center' style='width:100px'>".number_format($row['luaspanen'],2)."</td>
            </tr>
            ";
            $index++;
        }
    ...
    case 'updUpah':
        ...
        */
		//FA 20191108 - CDS/LSP
		$str = "select kodeorg, tahuntanam, norma, sum(hasilkerjakg) as tothasilkerja, 
                        ...
                        if ($hasilKg <= $basis || $basis <= $hasilKg) {
                            ...
                            if ($optRp[$paramBlok] !=0) {
                                ...
                                for ($awl = 0; $awl <= $JmlhRow; $awl++) {
                                    /*
									$str = "select hasilpanen, lebihbasiskg, rupiah, metode
									from kebun_5premipanen where  kebun_5premipanen.tahuntanam = ".$param['tahuntanam']
                                        ." and kebun_5premipanen.hasilpanen > ".$batasatas
                                        ." and  (bulanawal<=".$month." and bulanakhir>=".$month.") "
                                        ." and (kodeorg='".$_SESSION['empl']['regional']
										."' or kodeorg='".$_SESSION['empl']['lokasitugas']
										."' or kodeorg='".$param['blok']."') limit 1";
                                    */
									$str = "select hasilpanen, lebihbasiskg, rupiah, metode, premihadir
									from kebun_5premipanen where kebun_5premipanen.hasilpanen > ".$batasatas
                                        ." and  (bulanawal<=".$month." and bulanakhir>=".$month.") "
                                        ." and (kodeorg='".$_SESSION['empl']['regional']
										."' or kodeorg='".$_SESSION['empl']['lokasitugas']
										."' or kodeorg='".$paramBlok."') limit 1";
									$qstr = mysql_query($str);
                                    while ($rows = mysql_fetch_assoc($qstr)) {
									...
									// FA-20191030
									if ($rows['metode']==0 || ($rows['metode']==1 && $lbhbasis<$batasatas)) {
            ...
            if ($basis !=0) {
                if ($optDenda[$paramBlok] == 1) {
					...
					//else {
						...
						//echo "warning: xhasilkg=".$xhasilKg." /basis=".$basis." /isdobel=".$isDobel." /isgabung=".$isgabunghasil;
						//exit();
						...
						if ($optRp[$paramBlok] !=0) {
							...
							for ($awl = 0; $awl <= $JmlhRow; $awl++) {
								...
								from kebun_5premipanen where kebun_5premipanen.tahuntanam = ".$param['tahuntanam']
									...
									"kodeorg='".$_SESSION['empl']['lokasitugas']."' or ".
									"kodeorg='".$param['blok']."') limit 1";
								*/
								$str = "select hasilpanen, lebihbasiskg, rupiah, metode, premihadir
								from kebun_5premipanen where kebun_5premipanen.hasilpanen > ".$batasatas
									." and  (bulanawal<=".$month." and bulanakhir>=".$month.") "

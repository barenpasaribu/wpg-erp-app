	...
	case 'po':
		...
		switch ($param['tipe']) {
			case 'po':
				...
				$query = selectQuery($dbname, 'keu_tagihanht', "'PO',nopo,kodeorg", "nopo like '%" . $param['po'] . "%' and posting=1 and tipeinvoice='p' ");
				break;
			case 'k':
				$title = $_SESSION['lang']['kontrak'];
				$query = selectQuery($dbname, 'keu_tagihanht', "'Kontrak',nopo,kodeorg", "nopo like '%" . $param['po'] . "%' and posting=1 and tipeinvoice='k' ");
				break;
			case 'sj':
				$title = $_SESSION['lang']['nosj'];
				$query = selectQuery($dbname, 'keu_tagihanht', "'Surat Jalan',nopo,kodeorg", "nopo like '%" . $param['po'] . "%' and posting=1  and tipeinvoice='s' ");
				break;
			case 'ns':
				$title = $_SESSION['lang']['nokonosemen'];
				$query = selectQuery($dbname, 'keu_tagihanht', "'Konosemen',nopo,kodeorg", "nopo like '%" . $param['po'] . "%' and posting=1  and tipeinvoice='n'");
				break;
			case 'ot':
				$title = $_SESSION['lang']['lain'];
				$query = selectQuery($dbname, 'keu_tagihanht', "'Other',nopo,kodeorg", "nopo like '%" . $param['po'] . "%' and posting=1  and tipeinvoice='o'");
				break;
			case 'b':
				$title = 'Batch';

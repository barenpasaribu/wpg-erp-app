...
echo "<tr height=\"20\"><td colspan=\"2\">&nbsp;</td></tr>\r\n<tr><td colspan=\"2\"><button onclick=\"zPreview('pabrik_slave_logsheet_power1','";
echo $arr;
echo "','printContainer')\" class=\"mybutton\" name=\"preview\" id=\"preview\">Preview</button>";
// echo $arr;
echo "<button onclick=\"zExcel(event,'pabrik_slave_logsheet_power1.php','";
echo $arr;

...
//        $echo = array('success' => false, 'message' => '', 'data' => array());
        ...
        $data[] = array('tanggal' => tanggalsystemw($param['tanggal']));
...
*/
            ...
            $pdf->Cell(10, 10, ' : ',1);
            $pdf->Cell(300, 10,  $vp['nopo'] , 1, 1, 'L', 1);
            ...
            $pdf->Cell(10, 10, ' : ',1);
            $pdf->Cell(300, 10,number_format($vp['jumlah'], 0) , 1, 1, 'L', 1);
        ...
        $entry['header']['inputs'] = [
            ...
            array('field' => 'tanggalterima', 'caption' => 'Tanggal Terima', 'elements' => [
                array('field' => 'tanggalterima', 'type' => 'text', 'caption' => 'Tanggal Terima', 'class' => 'myinputtext',
                    ...
                    'onmousemove' => 'setCalendar(this.id)', 'value' => '')]
            ),

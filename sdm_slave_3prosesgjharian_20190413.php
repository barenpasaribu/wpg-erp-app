...
if (mysql_num_rows($qcekuser) > 0) {
	...
	$query1 = selectQuery($dbname, 'datakaryawan', 'karyawanid, nik, namakaryawan, tanggallahir, jms, statuspajak, npwp, kodejabatan, tipekaryawan, kodegolongan, idmedical', "tipekaryawan in(1,2,3,4,6) and lokasitugas='".$_SESSION['empl']['lokasitugas']."' 
	and (tanggalkeluar >= '".$tanggal1."' or tanggalkeluar is NULL)
	and (tanggalmasuk <= '".$tanggal2."' or tanggalmasuk='0000-00-00' or tanggalmasuk is null) 
	and alokasi=0 and sistemgaji='Harian' and karyawanid not in (0999999999,0888888888) order by karyawanid");
    ...
    //cek ...
	$strgjh = 'select  count(*) as jlh,b.karyawanid from '.$dbname.".sdm_hktdkdibayar_vw a left join ".$dbname.".datakaryawan b on a.karyawanid=b.karyawanid where b.tipekaryawan in (1,2,3,4,6) and b.lokasitugas='".$_SESSION['empl']['lokasitugas']."' and  (b.tanggalkeluar>='".$tanggal2."' or b.tanggalkeluar is NULL) and b.alokasi=0 and a.tanggal>='".$tanggal1."' and a.tanggal<='".$tanggal2."' and sistemgaji='Harian' group by a.karyawanid";
    $tdkdibayar = [];
    $resgjh = fetchData($strgjh);
    foreach ($resgjh as $idx => $val) {
    ...
    if ('KANWIL' == $tip || 'PABRIK' == $tip) {
        $str1 = 'select distinct a.*,b.namakaryawan,b.tipekaryawan,b.bagian,b.tanggallahir from '.$dbname.'.sdm_5gajipokok a left join '.$dbname.'.datakaryawan b on a.karyawanid=b.karyawanid left join '.$dbname.'.kebun_kehadiran_vw c on b.karyawanid=c.karyawanid where a.tahun='.substr($tanggal2, 0, 4)." and b.tipekaryawan in(1,2,3,4,6) and b.lokasitugas='".$_SESSION['empl']['lokasitugas']."' and  (b.tanggalkeluar>='".$tanggal1."' or b.tanggalkeluar is NULL) and b.alokasi=0 and b.sistemgaji='Harian' or c.tanggal>='".$tanggal1."' and c.tanggal<='".$tanggal2."' order by b.karyawanid,idkomponen";
    } else {
        $str1 = 'select distinct a.*,b.namakaryawan,b.tipekaryawan,b.bagian,b.tanggallahir from '.$dbname.'.sdm_5gajipokok a left join '.$dbname.'.datakaryawan b on a.karyawanid=b.karyawanid left join '.$dbname.'.kebun_kehadiran_vw c on b.karyawanid=c.karyawanid where a.tahun='.substr($tanggal2, 0, 4)." and b.tipekaryawan in(1,2,3,4,6) and b.lokasitugas='".$_SESSION['empl']['lokasitugas']."' and  (b.tanggalkeluar>='".$tanggal1."' or b.tanggalkeluar is NULL) and b.alokasi=0 and b.sistemgaji='Harian' or c.tanggal>='".$tanggal1."' and c.tanggal<='".$tanggal2."' order by b.karyawanid,idkomponen";
    }
    ...
    foreach ($tjms as $key => $nilai) {
        if ('BHL' == $tipekaryawan[$key] || 'ORGANIK' == $tipekaryawan[$key] || 'SKU' == $tipekaryawan[$key] || 'SKUP' == $tipekaryawan[$key] || 'PKWT' == $tipekaryawan[$key]) {
			...
			// Jika umur kurang dari 56 tahun 1 bulan, lanjut. Jika lebih, jumlah => 0
			if ($gabthnbln < 56.01) {
    ...
    $query2 = 'select a.karyawanid,sum(a.uangkelebihanjam) as lembur from '.$dbname.".sdm_lemburdt a left join ".$dbname.".datakaryawan b on a.karyawanid=b.karyawanid where b.tipekaryawan in(1,2,3,4,6) and b.lokasitugas='".$_SESSION['empl']['lokasitugas']."' and  (b.tanggalkeluar>='".$tanggal1."' or b.tanggalkeluar is NULL) and b.alokasi in(0) and sistemgaji='Harian' and ".$where2.' group by a.karyawanid';
    ...
    $query3 = 'select a.nik as karyawanid,sum(jumlahpotongan) as potongan, a.tipepotongan as tipepotongan from '.$dbname.".sdm_potongandt a left join ".$dbname.".datakaryawan b on a.nik=b.karyawanid where b.tipekaryawan in(1,2,3,4,5,6) and b.lokasitugas='".$_SESSION['empl']['lokasitugas']."' and  (b.tanggalkeluar>='".$tanggal1."' or b.tanggalkeluar is NULL) and b.alokasi in(0) and sistemgaji='Harian' and ".$where3.' group by a.nik';
    ...
    $query4 = 'select a.karyawanid,a.bulanan,a.jenis from '.$dbname.".sdm_angsuran a left join ".$dbname.".datakaryawan b on a.karyawanid=b.karyawanid where b.tipekaryawan in(1,2,3,4,6) and b.lokasitugas='".$_SESSION['empl']['lokasitugas']."' and  (b.tanggalkeluar>='".$tanggal1."' or b.tanggalkeluar is NULL) and b.alokasi in(0) and a.active=1 and sistemgaji='Harian' and ".$where4;
    ...
    $query3a = 'select a.karyawanid as karyawanid,a.jumlah as potongan, a.idkomponen as idkomponen from '.$dbname.".sdm_gaji a left join ".$dbname.".datakaryawan b on a.karyawanid=b.karyawanid where b.tipekaryawan in(1,2,3,4,6) and b.lokasitugas='".$_SESSION['empl']['lokasitugas']."' and  (b.tanggalkeluar>='".$tanggal1."' or b.tanggalkeluar is NULL) and b.alokasi in(0) and b.sistemgaji='Harian' and ".$where3a.' ';
    ...
    $stru1 = 'select distinct(tanggal) from '.$dbname.".kebun_kehadiran_vw a left join ".$dbname.".datakaryawan b on a.karyawanid=b.karyawanid where b.tipekaryawan in(1,2,3,4,6) and b.lokasitugas='".$_SESSION['empl']['lokasitugas']."' and  (b.tanggalkeluar>='".$tanggal1."' or b.tanggalkeluar is NULL) and b.alokasi=0 and a.unit like '".$_SESSION['empl']['lokasitugas']."%' and a.jurnal=0 and a.tanggal>='".$tanggal1."' and a.tanggal<='".$tanggal2."' and sistemgaji='Harian' order by tanggal";
    $resu1 = mysql_query($stru1);

    $stru2 = 'select distinct(tanggal) from '.$dbname.".kebun_prestasi_vw a left join ".$dbname.".datakaryawan b on a.karyawanid=b.karyawanid where b.tipekaryawan in(1,2,3,4,6) and b.lokasitugas='".$_SESSION['empl']['lokasitugas']."' and (b.tanggalkeluar>='".$tanggal1."' or b.tanggalkeluar is NULL) and b.alokasi=0 and a.unit like '".$_SESSION['empl']['lokasitugas']."%' and a.jurnal=0 and a.tanggal>='".$tanggal1."' and a.tanggal<='".$tanggal2."' and sistemgaji='Harian' order by tanggal";
...
//    $list0 .= '<td style="background-color:#efc6b1;font-weight:bold"><b>'.$_SESSION['lang']['potkoperasi'].'</b></td>';
    $list0 .= '<td style="background-color:#efc6b1;font-weight:bold"><b>Potongan Karyawan</b></td>';

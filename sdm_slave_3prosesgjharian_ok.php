...
//	exit();
	...
	$str1 = 'select distinct a.*,b.namakaryawan,b.tipekaryawan,b.bagian,b.tanggallahir from '.$dbname.'.sdm_5gajipokok a left join '.$dbname.'.datakaryawan b on a.karyawanid=b.karyawanid left join '.$dbname.'.kebun_kehadiran_vw c on b.karyawanid=c.karyawanid where a.tahun='.substr($tanggal1, 0, 4)." and b.lokasitugas='".$_SESSION['empl']['lokasitugas']."' and  (b.tanggalkeluar>='".$tanggal1."' or b.tanggalkeluar is NULL or b.tanggalkeluar='0000-00-00' or b.tanggalkeluar='0000-00-00') and b.sistemgaji='Harian' or c.tanggal>='".$tanggal1."' and c.tanggal<='".$tanggal2."' order by b.karyawanid,idkomponen";
	$res1 = fetchData($str1);
...
*/
			...
			$nilaibatasmax3 = 8000000; //bpjsmpt - sdm_ho_hr_jms_porsi
			if ('' != $nobpjskes[$key]) {
			...
			*/
			...
			if ($gabthnbln < 57.01) {
				$nilaibatasmax = 8094000; //jmppt - jaminan pensiun karyawan
			...
			// 10.000.000 - id komponen 66: biaya jabatan
			$nilaibatasmax3 = 10000000; // ambil dari sdm_ho_pph21jabatan
			if ($nilaibatasmax3 < $nilai) {

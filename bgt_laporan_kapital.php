...
echo '</label></td><td><select id=\'pt\'  style="width:150px;">';
echo $optpt;
echo '</select></td></tr>' . "\r\n" . '<tr><td><label>';
echo $_SESSION['lang']['namaorganisasi'];
echo '</label></td><td><select id=\'kdUnit\'  style="width:150px;">';
echo $optOrg;
echo '</select></td></tr>' . "\r\n" . '<tr height="20"><td colspan="2">&nbsp;</td></tr>' . "\r\n" . '<tr><td colspan="2"><button onclick="zPreview(\'bgt_slave_laporan_kapital\',\'';
echo $arr;
echo '\',\'printContainer\')" class="mybutton" name="preview" id="preview">';
echo $_SESSION['lang']['preview'];
echo '</button>' . "\r\n" . '<button onclick="zPdf(\'bgt_slave_laporan_kapital\',\'';
echo $arr;
echo '\',\'printContainer\')" class="mybutton" name="preview" id="preview">';
echo $_SESSION['lang']['pdf'];
echo '</button>' . "\r\n" . '        <button onclick="zExcel(event,\'bgt_slave_laporan_kapital.php\',\'';
echo $arr;

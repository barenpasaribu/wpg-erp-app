...
echo $_SESSION['lang']['laporanCatu'];
...
echo $optTip;
echo "\t</select></td>\r\n</tr>\r\n<tr height=\"20\"><td colspan=\"2\">&nbsp;</td></tr>\r\n<tr><td colspan=\"2\">\r\n\t<button onclick=\"zPreview('sdm_slave_2laporan_catu_beras','";
echo $arr;
echo "','printContainer')\" class=\"mybutton\" name=\"preview\" id=\"preview\">Preview</button>\r\n\t<!--<button onclick=\"zPdf('sdm_slave_2laporan_catu_beras','";
echo $arr;
echo "','printContainer')\" class=\"mybutton\" name=\"preview\" id=\"preview\">PDF</button>-->\r\n\t<button onclick=\"zExcel(event,'sdm_slave_2laporan_catu_beras.php','";
echo $arr;

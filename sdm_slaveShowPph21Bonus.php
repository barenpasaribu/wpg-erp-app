...
*/
	...
	//lepas and e.operator='".$opuser."' ==Jo 17-03-2017==
	 $strpph = "select f.nik,e.karyawanid,e.npwp,e.taxstatus,e.name, a.nettodanbonus, a.pph21danbonus, a.pph21atasbonus, g.value as nbonus, e.lastpayment 
		 ...
		 while($bar=mysql_fetch_object($res))
			{
			   ...
			   $bonus=0;
				...
				foreach($respph as $barpph){
					...
					$brutos=$gapok+$tjpph21+$tunjangandsb+$honariumdsb+$premiasuransi+$natura+$bonus;

<?
  ...
  $tgljtstnk=tanggalsystem($_POST['tgljtstnk']);
  ...
  switch($method){
      ...
      case 'update':
          $strx="update ".$dbname.".vhc_5master set jenisvhc='".$jenisvhc."',
            ...
            kodetraksi='".$kodetraksi."', 
            tgljtstnk='".$tgljtstnk."',
            tglakhirstnk='".$tglakhirstnk."',
            tglakhirkir='".$tglakhirkir."',
            tglakhirijinbm='".$tglakhirijinbm."',
  ...
  if($_SESSION['empl']['lokasitugas']=='MJHO'){
      ...
      $str="select * from ".$dbname.".vhc_5master where kodetraksi like '".$_SESSION['empl']['lokasitugas']."%' and ".$where." order by status desc,kodeorg,kodevhc asc";
  }

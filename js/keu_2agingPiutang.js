...
function getUsiaHutang()
{
	...
	customer  =document.getElementById('kodecustomer');
	tanggalpivot =document.getElementById('tanggalpivot').value;
		...
		customerV	=customer.options[customer.selectedIndex].value;

	param='pt='+ptV+'&gudang='+gudangV+'&tanggalpivot='+tanggalpivot+'&customer='+customerV;
	tujuan='keu_laporanUsiaPiutang.php';

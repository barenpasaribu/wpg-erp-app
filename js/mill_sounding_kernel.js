...

{
    ...
    //alert(param);
        ...
        tujuan='vhc_slave_save_sounding_kernel.php';
...
function fillFieldDetail(ids,trans_sounding,ukur1,ukur2,ukur3,ukur4,ruangisi,stok){
            document.getElementById('ids').value = ids;
            document.getElementById('no_trans_sounding').value = trans_sounding;
            document.getElementById('ukur1').value = numberWithCommas(ukur1);
            document.getElementById('ukur2').value = numberWithCommas(ukur2);
            document.getElementById('ukur3').value = numberWithCommas(ukur3);
            document.getElementById('ukur4').value = numberWithCommas(ukur4);
            document.getElementById('ruangisi').value = numberWithCommas(ruangisi);   
...
function simpan(){
    ...
    /*
      ...
      */
        ...
        post_response_text('vhc_slave_save_sounding_kernel.php?', param,respon);	 
...

{
        ...
        ukur4=document.getElementById('ukur4').value;
        ruangisi=document.getElementById('ruangisi').value;
        stok=document.getElementById('stok').value;


        param='ids='+ids+'&no_trans_sounding='+no_trans_sounding+'&ukur1='+ukur1+'&ukur2='+ukur2+'&ukur3='+ukur3;

        param+='&ukur4='+ukur4+'&ruangisi='+ruangisi+'&stok='+stok;       

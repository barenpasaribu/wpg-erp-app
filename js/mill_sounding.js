...

{
        ...
        KbnId=document.getElementById('KbnId').value;

        param='kodeorg='+KbnId+'&no_trans='+no_trans+'&tanggal='+tanggal;

        tujuan='setup_mill_generate_sisaawal.php';

...
function prepareEntryForm(sender,data,columnsize){
    ...
    if(sender.statusEntry=='Edit') {

    tr = tr + "\n" +
        "                    <tr>\n" +
        "                        <td colspan='"+(sender.columnSize*2)+"'>\n" +
        "                            <input type='hidden' name='nobatch' id='nobatch' value=''/>\n" +
        "                            <button id='saveHeader' name='btnSaveHeader' onclick=\"ConstructPage.saveHeader()\" disabled>Simpan</button>\n" +
        "                            <button id='resetHeader' name='btnResetHeader' onclick='ConstructPage.resetHeader()' disabled>Reset</button>\n" +
        "                        </td>\n" +
        "                    </tr>\n";
    } else {
    tr = tr + "\n" +
    ...
    html = html +
        ...
        "&nbsp;&nbsp;Total Debet&nbsp;:&nbsp;<input id='totaldebet' name='totaldebet' class='myinputtextnumber' onkeypress='return angka_doang(event)' type='text' value='' disabled='disabled'> " +
        "&nbsp;&nbsp;Total Kredit&nbsp;:&nbsp;<input id='totalkredit' name='totalkredit' class='myinputtextnumber' onkeypress='return angka_doang(event)' type='text' value='' disabled='disabled'> " +
        "&nbsp;&nbsp;Balance&nbsp;:&nbsp;<input id='balance1' name='balance1' class='myinputtextnumber' onkeypress='return angka_doang(event)' type='text' value='' disabled='disabled'> " +
        "&nbsp;&nbsp;DPP&nbsp;:&nbsp;<input id='nilai_invoice' name='nilai_invoice' class='myinputtextnumber' onkeypress='return angka_doang(event)' type='text' value='' disabled='disabled'> " +
        "&nbsp;&nbsp;PPn&nbsp;:&nbsp;<input id='nilai_ppn' name='nilai_ppn' class='myinputtextnumber' onkeypress='return angka_doang(event)' type='text' value='' disabled='disabled'> " +
        "&nbsp;&nbsp;PPH&nbsp;:&nbsp;<input id='nilai_pph' name='nilai_pph' class='myinputtextnumber' onkeypress='return angka_doang(event)' type='text' value='' disabled='disabled'> " +
...
function entryAfterExecute(obj){
    ...
    if (obj.headerData!=null) {
        ...
        var tmp1 = document.getElementById('jumlah');
        if (tmp != null) {
            tmp1.value = total;
        }
    }
...
function setPoInv(nobatch) {
        ...
        if (chk == null) {
            ...
            if (chk.getAttribute('disabled')==null) {
                if (chk.checked) {
                    ...
                    var pph = getById('hidden_pph__el_inv_' + idx).value;
                    pph = pph.replace(/,/g, '') ;
                    totalPPH = totalPPH + Number(pph);
                    var tgljt = getById('hidden_tgljt_el_inv_' + idx).value;
                    pph = Number(pph);
                    ppn = Number(ppn);
    ...
    document.getElementById('tanggaljatuhtempo').value=tgljt;
    document.getElementById('rpInvoice').value=Intl.NumberFormat('en-US').format(totalInvoice+totalPPN-totalPPH);
    document.getElementById('jumlah').value=Intl.NumberFormat('en-US').format(totalInvoice+totalPPN-totalPPH);

    document.getElementById('nilai_invoice').value=Intl.NumberFormat('en-US').format(totalInvoice);
    document.getElementById('nilai_ppn').value=Intl.NumberFormat('en-US').format(totalPPN);
    document.getElementById('nilai_pph').value=Intl.NumberFormat('en-US').format(totalPPH);

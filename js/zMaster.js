...
function masterExcell(table,column,cond,page,event) {
        ...
        showDialog1("<iframe frameborder=0 style='width:795px;height:400px' src='"+page+".php?"+param+"'></iframe>",'800','400',event);

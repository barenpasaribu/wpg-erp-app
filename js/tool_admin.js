...
function getFormUplaod(type){
    ...
    if(type=='ACCBAL')
        {  
        document.getElementById('sample').innerHTML ='<b>Previous Accounting Balance. This form must be preceded by a header on the first line.</b> <a href=tool_slave_getExample.php?form=ACCBAL target=frame>Click here for example</a'; 
        }
    if(type=='JOURNAL')
        {

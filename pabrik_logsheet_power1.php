...
if( isset($_POST['btnSubmit']) ){
	...
	{	
		...
		$qry="insert into ".$dbname.".tmp_power1ht values('".$nama_file."','".$kdOrg."','".$date."'); ";
		...
		{ 
			...
			$hm_awal_g1=preg_replace("/[^0-9.]/", "", $data->val($i, 2));
			$hm_akhir_g1=preg_replace("/[^0-9.]/", "", $data->val($i, 3));
			
			$hm_awal_g2=preg_replace("/[^0-9.]/", "", $data->val($i, 4));
			$hm_akhir_g2=preg_replace("/[^0-9.]/", "", $data->val($i, 5));
			$hm_awal_g3=preg_replace("/[^0-9.]/", "", $data->val($i, 6));
			$hm_akhir_g3=preg_replace("/[^0-9.]/", "", $data->val($i, 7));
			$gg_hm=preg_replace("/[^0-9.]/", "", $data->val($i, 8));
			$gt_hm=preg_replace("/[^0-9.]/", "", $data->val($i, 9));
			$kwh_g1=preg_replace("/[^0-9.]/", "", $data->val($i, 10));
			$kwh_g2=preg_replace("/[^0-9.]/", "", $data->val($i, 11));
			$kwh_g3=preg_replace("/[^0-9.]/", "", $data->val($i, 12));
			$bbm_g1=preg_replace("/[^0-9.]/", "", $data->val($i, 13));
			$bbm_g2=preg_replace("/[^0-9.]/", "", $data->val($i, 14));
			$bbm_g3=preg_replace("/[^0-9.]/", "", $data->val($i, 15));
			...
			// menyimpan data xls ke db tmp_absensidt
			 $qry1="insert into ".$dbname.".tmp_power1dt values('".$nama_file."','".$tgl."','".$hm_awal_g1."','".$hm_akhir_g1."','".$hm_awal_g2."','".$hm_akhir_g2."','".$hm_awal_g3."','".$hm_akhir_g3."','".$gg_hm."','".$gt_hm."','".$kwh_g1."','".$kwh_g2."','".$kwh_g3."','".$bbm_g1."','".$bbm_g2."','".$bbm_g3."',current_timestamp); ";				
		...
		*/
		...
		// */
		// $totx= $res1['totx'];
		$squery="SELECT * FROM tmp_power1dt  where namafile='".$nama_file."' ";
...
if( $_POST['btnSubmitData']!=""){
	...
	if( $total_data > 0){
		...
		// get data karyawan
		$squery="SELECT a.*,b.kodeorganisasi as kodeorg FROM tmp_power1dt a,tmp_power1ht b  where a.namafile=b.namafile and a.namafile='".$namafile."' ";
		// echo "<pre>";
		// print_r($squery);
		// die();
		$hasil = mysql_query($squery);
		while ($res = mysql_fetch_array($hasil)) { 
			...
			$queryCekAbsensiDT = "SELECT * FROM pabrik_power1 WHERE kodeorg = '".$kodeorg."' and tgl = '".$tgl."' ";
			...
			if($jumlahCekAbsensiDT > 0){
				$sDetIns = "UPDATE ".$dbname.".pabrik_power1 
							SET
								hm_awal_g1 = '".$hm_awal_g1."',
								hm_akhir_g1='".$hm_akhir_g1."',
								hm_awal_g2='".$hm_awal_g2."',
								hm_akhir_g2='".$hm_akhir_g2."',
								hm_awal_g3='".$hm_awal_g3."',
								hm_akhir_g3='".$hm_akhir_g3."',
								gg_hm='".$gg_hm."',
								gt_hm='".$gt_hm."',
								kwh_g1='".$kwh_g1."',
								kwh_g2='".$kwh_g2."',
				...
				$sDetIns = "insert into ".$dbname.".pabrik_power1 values('".$namafile."','".$tgl."','".$hm_awal_g1."','".$hm_akhir_g1."','".$hm_awal_g2."','".$hm_akhir_g2."','".$hm_awal_g3."','".$hm_akhir_g3."','".$gg_hm."','".$gt_hm."','".$kwh_g1."','".$kwh_g2."','".$kwh_g3."','".$bbm_g1."','".$bbm_g2."','".$bbm_g3."',current_timestamp,'".$kodeorg."'); ";	
			}
		...
		$emptyQueryTable2 = "TRUNCATE TABLE tmp_power1dt ";
...
OPEN_BOX('', 'Pabrik Logsheet Power 1 Upload</b>');

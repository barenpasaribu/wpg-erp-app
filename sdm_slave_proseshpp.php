...
*/
		...
		if ($nrapel > 0){
			...
			while($nx <= $nbln) {
				...
				$prdgjloop= substr($param['periodegaji'],0,5).$strnx;
				$qGaji = "select * from sdm_gaji_rekap2_vw where karyawanid='".$idxx."' and substr(periodegaji,1,4)=".$thn." and periodegaji='".$prdgjloop."'";
	...
	/*
	$xptkp= $ptkp[$val[0]];
	$xppersen= $pphpercent[0];
	$akum= $akumulasi_pph21[$val[0]];
	if ($idxx=='0000000024' && $nx==3){
	echo "warning LOOP: pph rapel setahun= ".$pph21rapel_setahun." /persen= ".$xppersen." /pkp= ".$pkpx." /ptkp= ".$xptkp." /netto= ".$netto." /bruto= ".$bruto." /by jab= ".$byjab." /bulan= ".$pembagi_bulan." /loop ke nx= ".$nx;
	exit();
	}
	*/
...
/*
if ($idxx=='0000000024'){
echo "warning nx: nx= ".$nx." /.nbln= ".$nbln;
exit();
}
*/		
			if ('' == $npwp[$val[0]]) {
...
$akum= $akumulasi_pph21[$val[0]];
if ($idxx=='0000000024'){
echo "warning XXX: bln= ".$nbln." /pph rapel setahun= ".$pph21rapel_setahun." /pphrapel= ".$pphrapel." /pph akum= ".$akum." /pph rapel akhir= ".$pp21." /pkp= ".$pkpx;
exit();
}
*/
